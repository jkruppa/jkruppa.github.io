...
#| fig-height: 10
#| fig-width: 15
#| fig-cap: "Visueller Zusammenhang eines kontinuierlichen Outcomes ($y$) aus einer Normalverteilung (*Gaussian*) im Verhätnis zu verschiedenen Einflussvariablen ($x$). **(A)** text. **(B)** text. **(C)** text [Zum Vergrößern anklicken]*"
