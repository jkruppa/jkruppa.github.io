...
#| label: fig-marginal-model-intro-02
...
predictions(gam_fit, newdata = datagrid(ph = c(-1, 2, 6)))
...
predictions(loess_fit, newdata = datagrid(ph = c(-1, 2, 6)))
```
...
#| fig-width: 9.5
#| fig-cap: " *[Zum Vergrößern anklicken]*"
#| label: fig-marginal-model-intro-03
...
#| fig-width: 9.5
#| fig-cap: "Scatterplot der kontinuierlichen x-Werte und kontinuierlichen y-Werte. In einem Modell wird die Abhängigkeit von y und x modellieren. **(A)** Linearer Zusammenhang. **(B)** Quadratischer Zusammenhang. *[Zum Vergrößern anklicken]*"
#| label: fig-marginal-model-intro-00-1
