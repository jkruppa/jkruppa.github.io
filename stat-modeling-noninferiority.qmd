...
Wir können die Funktion `geom_smooth()` nutzen um eine lineare Funktion durch die Punkte zu legen. Wir sehen ist der Fehler, dargestellt als grauer Bereich, bei den CMYK-Werten größer.
...
Für die geneuen Werte der linearen Funktion nutzen wir dann die Funktion `lm()`
