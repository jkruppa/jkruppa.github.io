...
In der folgenden @fig-teststatistik-07 ist dann nochmal der Zusammenhang aus der Tabelle als eine Abbildung visualisiert. Mit dem $p$-Wert entscheiden wir anhand von *Flächen*.

::: column-page
![Die Flächen aus der @fig-teststatistik-01 nochmal separat dargestellt. Wir vergleichen bei der Entscheidung mit dem $p$-Wert nicht die berechnete Teststatistik $T_{calc}$ mit dem kritischen Wert $T_{\alpha = 5\%}$ sondern die Flächen rechts von den jeweiligen Teststatistiken mit $A_K = 5\%$ und $A_{calc}$ als den $p$-Wert. Daran machen wir dann die Testentscheidung fest.](images/t-verteilung_07.png){#fig-teststatistik-07 fig-align="center"}
:::
