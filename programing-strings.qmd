...
time_vec <- read_table("data/day_values_osnabrueck.txt") %>% 
  clean_names() %>% 
  pull(jjjjmmdd)
```
...
::: column-margin
Hier hilft das [R Paket lubridate - Make Dealing with Dates a Little Easier](https://lubridate.tidyverse.org/) und natürlich das Tutorial [Dates and times](https://r4ds.had.co.nz/dates-and-times.html).
:::
