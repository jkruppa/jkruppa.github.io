...
-   Wachsamkeit und Konzentration für 90 Minuten. Aufmerksamkeit flackert ein und aus. Bevor er 1-2 Stunden lang wirklich ruhen muss, bevor er wieder sehr hart arbeiten kann.
...
die innerhalb von 4 Stunden nach diesen 90-minütigen Lerneinheiten durchgeführt werden, beschleunigen das Lernen.

3.  

-   Machen Sie ab und zu 10 Sekunden Pause vom Lernen, in denen Sie nichts tun,
-   Machen Sie den Kopf frei (Lückeneffekt/Mikropausen),
-   Der Hippocampus wiederholt die Informationen mit 20-facher Geschwindigkeit und beschleunigt das Lernen und Behalten der neu gelernten Informationen.
-   Wirkt sich das auf körperliche und geistige Fähigkeiten aus?

4.  

-   Inkrementelles Lernen. Sie können die Arbeit/das Lernen in kleine, konzentrierte Einheiten aufteilen.
-   Stellen Sie einen Timer für 3 Minuten ein, schalten Sie das Telefon aus und verbringen Sie 3 Minuten damit, diese eine Sache intensiv zu lernen, auch wenn es sich anfühlt, als würden Sie versagen.
-   Wenn Sie dies wiederholt tun, können diese kleinen Schritte des Lernens zu einer übergroßen Menge des Lernens insgesamt führen.
