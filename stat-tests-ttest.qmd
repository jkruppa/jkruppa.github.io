...
> Hier muss man noch bedenken, dass die Freiheitsgrade anders berechnet werden. Die Freiheitsgrade werden wie folgt berechnet mit $df = \cfrac{\left(\cfrac{s^2_{y_1}}{n} +
> \cfrac{s^2_{y_2}}{m}\right)^2}{\cfrac{\left(\cfrac{s^2_{y_1}}{n}\right)^2}{n-1} + \cfrac{\left(\cfrac{s^2_{y_2}}{m}\right)^2}{m-1}}$. Was aber in der eigentlichen Anwendung nichts zur Sache tut. Deshalb gehen wir hier auch nicht tiefer darauf ein.
:::
...
### Einstichproben t-Test gegen eine Konstante

------------------------------------------------------------------------

![](images/caution.png){fig-align="center" width="50%"}

**Dieser Abschnitt ist eine Baustelle. Daher können Teile des Codes und des Textes kurzfristig keinen Sinn ergeben oder nicht funktional sein. Es ist geplant eine fertige Version noch 2024 vorliegen zu haben.**
