...
Eben gerade haben wir das `{emmeans}` Objekt für unsere zweifaktorielle Analyse für die getrennte Analyse über den zweiten Faktor genutzt. Jetzt zeige ich dir in den folgenden Tabs einmal wie du die p-Werte, das *Comapct letter display* und die 95% Konfidenzintervalle für die kombinierte Analyse über die beiden Faktoren $f_1$ und $f_2$ berechnest.
