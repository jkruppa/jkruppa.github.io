...
#| warning: false
#| echo: false
pacman::p_load(tidyverse, readxl, knitr, kableExtra, duke, conflicted)
...
Auch hier wurde die CRAN Unterstützung eingestellt, so dass die Installation wie folgt über GitHub geht.

```{r}
devtools::install_github("cran/duke")
```

Danach kannst du dir dann alles ganz normal anzeigen lassen, wie ich es im Folgenden mache.
...
: Ausgewählte HTML Codes und deren Darstellung.
