...
Nur sinnvoll, wenn keine Interaktion vorliegt.
...
$$
\begin{aligned}
&SS(A \mid B,\, A \times B) \; \mbox{für den Faktor A gegeben der Interaktion und Faktor B} \\
&SS(B \mid A,\, A \times B) \; \mbox{für den Faktor B gegeben der Interaktion und Faktor A}\\
\end{aligned}
$$
:::
