...
![Beispiel für drei der acht Berge mit *Bavarian*, *Central* und *Julian*. Auf jeden der acht Berge wurden an drei Seiten *a*, *b* und *c* die Testscores der dortigen Drachen erhoben.](images/mountain.png){#fig-mountain-site fig-align="center" width="70%"}
...
lm_fit <- lm(test_score ~ body_length_cat, data = dragons_tbl)
...
compare_performance(lm_fit, lm_mountain_fit, lmer_1_fit, lmer_2_fit,rank = TRUE)
```
