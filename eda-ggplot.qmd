...
![kjasdsaddssd](images/boxplot-drawn-distribution.png){#fig-boxplot-drawn-distribution fig-align="center" width="100%"}

![kjasdsaddssd](images/boxplot-drawn-flipped.png){#fig-boxplot-drawn-flipped fig-align="center" width="80%" height="80%"}

@fig-boxplot-drawn

@fig-boxplot-drawn-distribution

@fig-boxplot-drawn-flipped
...
ggplot(dog_fleas_tbl, aes(x = "1", y = flea_weight)) + 
  geom_boxplot() +
  theme_bw() +
  labs(x = "", y = "Gewicht [mg]") 
