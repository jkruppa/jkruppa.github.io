...
Beginnen wir also mit der linearen Diskriminanzanalyse (eng. *Linear discriminant analysis*). Wir versuchen dabei die vordefinierten Klassen anhand der Variablen in den Spalten durch Linien voneinander zu trennen.
...
partimat(class ~ flavanoids + nonflavanoid_phenols, data = wine_tbl, method = "lda")

partimat(class ~ alcohol + nonflavanoid_phenols, data = wine_tbl, method = "lda")
