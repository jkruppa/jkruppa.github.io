...
Das klingt jetzt alles etwas kryptisch und deshalb wollen wir uns die Sachlage einmal an einem Beispiel anschauen.
...
#| message: false
#| warning: false
hypotheses(feeding_stage_weight_fit, hypothesis = "b2 - b1 = 0")
```
