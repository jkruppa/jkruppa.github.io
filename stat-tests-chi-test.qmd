...
Hier sehen wir dann auch den Unterschied zwischen den beiden Funktionen. Wir können für die Funktion `pairwise_prop_test()` etwas einfacher das *Compact letter display* berechnen lassen.
