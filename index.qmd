...
7)  [Ideen zu Frauen in der Statistik erarbeiten](#sec-spielecke)
8)  [Einen Boxplot zerforschen](#sec-spielecke)
9)  [EDA Kapitel aufräumen und Redundanzen entfernen](#sec-eda-ggplot)
...
i)  Global den Pipe-Operator von `%>%` zu `|>` wechseln.
ii) R Pakete in `{}` schreiben.
iii) Zitate zu den Kapiteln ergänzen und sinnvoll anpassen.
iv) Zitate und Quellen für wissenschaftliche Veröffentlichungen ergänzen.
v)  Rechtschreibung und Grammatik systematisch überprüfen.
:::
