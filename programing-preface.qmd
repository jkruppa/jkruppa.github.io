...
Was solltest du nun zuerst Lesen um Programmieren in R zu verstehen und zu lernen? Es ist sehr schwierig die Programmierung exakt so zu schreiben, dass das Programmieren *linear* verständlich ist. Du brauchst im Prinzip das Wissen aus @sec-basics *Operatoren, Funktionen und Pakete* um die Grundlagen von Operatoren und Funktionen in R zu verstehen. Auf der anderen Seite fehlt dir vielleicht noch das Verständnis von Buchstaben und Zahlen in R. Diesen Zusammenhang zwischen Buchstaben und Zahlen erkläre ich als erstes im folgenden @sec-letter-number *Von Buchstaben und Zahlen*. Vielleicht musst du beide Kapitel nochmal lesen. Oder aber in der Anwendung sehen. Stell dir vor es ist wie eine Sprache zu lernen. Ohne Vokabeln keine Sätze aber ohne Grammatik kein Sinn.
...
Fangen wir also an die Grammatik und die Vokablen in R zu verstehen um dann mit dem Rechner kommunizieren zu können.
