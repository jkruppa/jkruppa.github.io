...
#| fig-height: 5.5
#| fig-width: 9.75
#| fig-cap: "Simulationsstudie zur Erkennung der Varianzhomogenität und Vamrianzheterogenität in drei Gruppen. Auf der y-Achse ist der Anteil der Erkennung in 1000 Simulationen angegeben. Auf der x-Achse sind die Fallzahlen per Gruppe dargestellt. **(A)** Varianzhomogene Gruppen und zwei statistische Test für deren Erkennung.  **(B)** Varianzheterogene Gruppen und zwei statistische Test für deren Erkennung sowie die Entscheidung mit einem Signifikanzniveau $\\alpha$ von 5% sowie 20%. *[Zum Vergrößern anklicken]*"
...
-   Der [Levene-Test (abk. *Levene*)](https://de.wikipedia.org/wiki/Levene-Test)
-   Der [Bartlett-Test (abk. *Bartlet*)](https://de.wikipedia.org/wiki/Bartlett-Test)
-   Der Fligner-Killeen (abk. *Flinger*)
...
Varianzheterogenität (eng. *heteroscedasticity*)

Wort zur Metaanalyse

:::::: panel-tabset
## `{performance}`

`check_heteroscedasticity()` aus dem R Paket `{performance}` Breusch-Pagan test
...
#| echo: true
#| warning: false
#| label: fig-ggplot-check-pretest-variance-f1-hetero
#| fig-align: center
#| fig-height: 4
#| fig-width: 6
#| fig-cap: "Schnelle Abbildung der Residuen aus `check_homogeneity()` zur Überprüfung der Varianzhomogenität der Faktoren in einem einfaktoriellen Modell."
...
#| echo: true
#| warning: false
#| label: fig-ggplot-check-pretest-variance-f2-3
#| fig-align: center
#| fig-height: 4
#| fig-width: 6
#| fig-cap: "Schnelle Abbildung der Residuen aus `check_homogeneity()` zur Überprüfung der Varianzhomogenität der Faktoren in einem zweifaktoriellen Modell."
...
#| echo: true
#| warning: false
#| label: fig-ggplot-check-pretest-variance-f2-4
#| fig-align: center
#| fig-height: 4
#| fig-width: 6
#| fig-cap: "Schnelle Abbildung der Residuen aus `check_homogeneity()` zur Überprüfung der Varianzhomogenität der Faktoren in einem zweifaktoriellen Modell."
