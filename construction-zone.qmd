...
ggplot() +
  ...
  geom_function(fun = a_line, linewidth = 1) +
...
slope_annotations <- tibble(
  ...
  mutate(y = a_parabola(x),
         ...
         nice_slope = glue("Slope (dy/dx)<br><span style='font-size:12pt;color:{cb_pal[4]}'>**{slope}**</span>"))
...
ggplot() +
  geom_vline(xintercept = 0, linewidth = 0.5, color = "grey50") +
  geom_hline(yintercept = 0, linewidth = 0.5, color = "grey50") +
  geom_function(fun = u_cookies, linewidth = 1) +
