...
Wir du siehst wird hier noch nichts gerechnet. Es gilt jetzt zu definieren was wir tun wollen. Damit wir das Rezept einfahc immer wieder auf neue Daten anwenden können. Die Rollen der Variablen kannst du dir auch über die Funktion `summary()` wiedergeben lassen.
...
Nun heißt es noch den Wirkflow mit echten Daten zu füttern. Wir nehmen hier wieder unsere ursprünglichen Daten, aber du könntest hier auch den Traingsdatensatz nehmen.
...
Wir erhalten den klassischen Fit einer logististischen Regression wieder, wenn wir die Funktion `extract_fit_parsnip()` verwenden. Dann können wir uns über die Funktion `tidy()` auch eine aufgeräumte Wiedergabe erstellen lassen.
