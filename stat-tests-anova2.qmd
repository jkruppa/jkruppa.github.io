...
Der häufigste angewendete Effektschätzer ist [$Eta^2$](https://easystats.github.io/effectsize/articles/anovaES.html#eta2) oder auch $\eta^2$ geschrieben. Wir können $\eta^2$ relativ einfach aus den Abweichungsquadraten des Faktors $SS_A$ geteilt durch die gesamten Abweichungsquadrate $SS_{Total}$ berechnen. Das $\eta^2$ funktioniert besonders gut in der Anwenbdung einer einfaktoriellen ANOVA. Wir haben dann folgenden Zusammenhang.
...
[Omega Squared: Definition](https://www.statisticshowto.com/omega-squared/)

[Epsilon Squared: Definition](https://www.statisticshowto.com/epsilon-squared/)
