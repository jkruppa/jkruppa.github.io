...
Achtung, unbedingt `serie = 0` als Option nutzen, sondt klappt es nicht mit der Option die `plots` gleich den Spalten `cols` zu setzen. Ja, ich weiß, ist alles super suboptimal.
