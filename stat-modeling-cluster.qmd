...
In der @fig-dist-01 kannst du dir die Distanzmatrix als Heatmap anzuschauen. Die Funktion `fviz_dist()` aus dem R Paket `factorextra` ermöglicht dir die Distanzmatrix zu visualisieren. Wir nutzen die Distanzmatrix dann aber gleich um auf den Distanzen Cluster zu bilden.
