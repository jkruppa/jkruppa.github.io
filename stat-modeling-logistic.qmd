...
Ein schönes Beispiel liefert auch @ramprasad2025smartphone mit der Arbeit [Smartphone use on the toilet and the risk of hemorrhoids](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0329983). Was ja irgendwie jeder von uns macht, also die Nutzung von einem Handy auf der Toilette und dann doch ein bedeutendes Problem sein kann. In der folgenden Abbildung siehst du einmal die Ergebnisse der multiplen logistischen Regression. Hier wird mal wieder der Begriff multivariat benutzt, den ich hier aber als falsch ansehe. Es ist ein multiples Modell und gut ist. Jetzt ist also die Frage, was die Odds Ratio (abk. *OR*) nun aussagen sollen.

![*In a multivariate logistic regression, smartphone use on the toilet was associated with a 46% increased risk of hemorrhoids (p = 0.044) after adjusting for age, sex, BMI, exercise activity, straining, and fiber intake* Quelle: @ramprasad2025smartphone](images/preface_logistic_regression.png){#fig-utest-intro fig-align="center" width="100%"}
...
-   Das Tutorium [Logistic Regression by Steven V. Miller](https://post8000.svmiller.com/lab-scripts/logistic-regression-lab.html#Elsewhere_on_My_Website) erklärt nochmal die logistische Regression von vorne bis hinten, wie ich es hier nicht in dem Detail kann. Wenn du mehr zu logistischen Regression lesen willst, dann ist es eine wirkliche Empfehlung.
