...
%%| fig-width: 6
%%| fig-cap: "Abhängigkeitsstruktur des *randomized complete block design*. Der Faktor `soil` und der zweite Faktor `fert` sind in dem Block genested und randomisiert."
flowchart LR
