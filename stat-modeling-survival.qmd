...
::: column-margin
Tja, [*All your base are belong to us*](https://en.wikipedia.org/wiki/All_your_base_are_belong_to_us) kann man da nur sagen...
:::
...
Einmal bitte auch @suresh2022survival anschauen mit der Veröffentlichung [Survival prediction models: an introduction to discrete-time modeling](https://bmcmedresmethodol.biomedcentral.com/articles/10.1186/s12874-022-01679-6).

Dann gibt es noch zwei Tutorien, die ich dann nochmal aufarbeiten muss.
