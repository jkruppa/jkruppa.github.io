...
pacman::p_load(tidyverse, readxl, knitr, kableExtra, quantreg,
               ...
               ggdist, gghalves, performance, parameters,
...
-   **Violinplot** in @sec-eda-violinplot für die Kombination von einem Densityplot und einem Boxplot. Dann können wir hier noch den Dotplot ergänzen und haben eine sehr informative Übersichtsabbildung.
...
#| fig-height: 0.75
#| fig-width: 6
#| fig-cap: "Farbpalette nach dem Okabe-Ito-Schema ebenfalls für farbblinde Personen erstellt."
...
#| fig-height: 0.75
#| fig-width: 6
#| fig-cap: "Farbpalette nach dem Duke-Schema ebenfalls für farbblinde Personen erstellt."
...
#| fig-height: 5
#| fig-width: 5
#| fig-cap: "Beispielhafte Abbildung der Barplots mit gebrochener $y$-Achse. Die Fehlerbalken wurden aus Gründen der besseren Darstellung der zerbrochenen $y$-Achse entfernt."
