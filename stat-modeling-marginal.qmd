...
Kommen wir nochmal zu einer praktischen Anwendung.

::: callout-tip
## Anwendungsbeispiel: Zeitlicher Verlauf von Entenausflügen

![foo.](images/marginal/ducks.png){#fig-flea-yedi fig-align="center" width="80%"}
...
model_full_sq |> 
  slopes(variables = "timeblock_num",
         newdata = datagrid(timeblock_num = c(1, 12, 20),
                            breed = unique))
```
...
model_full_sq |> 
  slopes(variables = "timeblock_num",
         newdata = datagrid(timeblock_num = c(10, 20),
                            breed = unique))
```
...
model_full_sq |> 
  slopes(variables = "timeblock_num",
         newdata = datagrid(timeblock_num = c(10),
                            breed = unique),
         hypothesis = difference~pairwise)
```
