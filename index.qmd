...
::: callout-caution
## Baustellen im SoSe 2024

Was tippe ich zur Zeit und welche Baustellen sind hier im Skript gerade offen? Im Folgenden einmal die lose Liste für das aktuelle Semester. Die dargestellte Reihenfolge ist nicht die Reihenfolge in der ich an den Texten arbeite. Auch schaffe ich meistens nichts alles in einem Semester --- daher handelt es sich nur um einen groben Überblick.

1)  [Permutationstest & Bootstraping](#sec-permut) um Bootstrap ergänzen und überarbeiten
2)  [Fragebogenanalyse](#sec-modeling-survey) mit Beispielen versehen und Konzept erstellen
3)  [Modellieren in R](#sec-modeling-R) mit Text und Ideen füllen
4)  [Räumliche Daten](#sec-spatial-data) mit Text und Ideen füllen
5)  [Metaanalysen](#sec-meta) restlichen Text schreiben und schauen was noch fehlt
:::
