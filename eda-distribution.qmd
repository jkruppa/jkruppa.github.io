...
Für die Berechnung der Formel der Binomalverteilung brauchen wir auch den Binomialkoeffizienten $\tbinom {n}{k}$, den wir wie folgt berechnen können.

$$
\binom nk = \cfrac{n!}{k! \cdot (n-k)!}
$$

Nehmen wir dafür einmal ein Beispiel mit 5 über 3 und berechnen den Binomialkoeffizienten $\tbinom {5}{3}$ wie folgt.
...
Das Pascalsche (oder Pascal'sche) Dreieck ist eine Form der grafischen Darstellung der Binomialkoeffizienten $\tbinom {n}{k}$

![Darstellung des Pascalsche (oder Pascal'sche) Dreieckes im Zusammenhang zum Binomialkoeffizienten.](images/distribution-binom.png){#fig-tdist-01 fig-align="center" width="80%"}
