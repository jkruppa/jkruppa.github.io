...
Sieh dazu auch das Inhaltsverzeichnis von dem R Paket `agricolae` mit [Experimental Designs with agricolae](https://myaseen208.com/agricolae/articles/ExperimentalDesign.html) einmal genauer an.
:::
...
Wir betrachten hier nur die Spaltanlage (eng. *split plot design*) und nicht die Streifenanalge (eng. *strip plot design*). Wie schon anfamgs gesagt, wenn hier Bedarf besteht einfach eine Mail schreiben.
