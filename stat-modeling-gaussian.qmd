...
pacman::p_load(tidyverse, magrittr, conflicted, broom,
               see, performance, emmeans, multcomp)
...
#| fig-height: 5
#| fig-width: 5
#| fig-cap: "Ausgabe ausgwählter Modelgüteplots der Funktion `check_model()`."
#| fig-subcap: 
#|   - "Normalverteilung der Residuen"
#|   - "Mögliche Ausreißer"
#|   - "Normalverteilung der vorhergesagten Werte"
#| layout-nrow: 1
#| column: page

check_model(gaussian_fit, colors = cbbPalette[6:8], check = "qq")

check_model(gaussian_fit, colors = cbbPalette[6:8], check = "outliers")

check_model(gaussian_fit, colors = cbbPalette[6:8], check = "pp_check")
```
