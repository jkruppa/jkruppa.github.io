...
1)  Wir wollen eine [mehrfaktorielle ANOVA](#sec-anova) oder eine [mehrfaktorielle ANCOVA](#sec-anova). Je nachdem wie viele Fakoteren $f$ oder Covariaten $c$ wir in den Daten haben.
