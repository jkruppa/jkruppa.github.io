...
fit_4 <- games_howell_test(jump_length ~ animal, data = fac2_tbl) 
...
```{r}
data_tbl <- tibble(trt = gl(9, 20, 
                            labels = c("dtl", "ctrl", "treat1", "treat2", 
                                       "treatA2", "treatB", "treatB2", "treatC", 
                                       "treatD")),
