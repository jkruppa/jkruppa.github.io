...
*Letzte Änderung am `r format(fs::file_info("stat-modeling-permutationstest.qmd")$modification_time, '%d. %B %Y um %H:%M:%S')`*
...
::: column-margin
Wie immer gibt es auch hier noch ein erweiteres Tutorium von Ben Bolker [Simple permutation tests in R](https://mac-theobio.github.io/QMEE/lectures/permutation_examples.notes.html) oder aber das R Paket [infer](https://infer.netlify.app/).
:::
