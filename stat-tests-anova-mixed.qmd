...
Willst du wirklich eine *repeated* ANOVA rechnen oder doch eher eine mixed ANOVA? Der Unterschied ist suubtil und hängt davon ab, welche Behandlungskombinationen deine einzelnen Beobachtungen `.id` erhalten haben. Schaue im Zweifel nochmal oben in der Einleitung um dich zu versichern. Häufig möchtest du nämlich eine mixed ANOVA rechnen.
:::
