...
lizard_zero_infl_intercept_fit %>% summary
```
...
```{r}
compare_performance(lizard_fit,
                    lizard_zero_nb_intercept_fit,
                    lizard_zero_infl_intercept_fit, 
                    lizard_zero_infl_rain_fit,
                    lizard_zero_infl_rain_pop_fit,
                    rank = TRUE)
```
