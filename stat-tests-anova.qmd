...
Wir wollen nun einmal die zweifaktorielle ANOVA ohne Interaktionsterm rechnen die in @tbl-anova-fac2-ohne-inter darsgestellt ist. Die $SS$ und $MS$ für die zweifaktorielle ANOVA berechnen wir nicht selber sondern nutzen die Funktion `anova()` in R.
