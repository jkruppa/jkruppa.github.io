...
Wenn du dann noch einen Effektschätzer brauchst, dann kannst du das R Paket `{effectsize}` mit der Funktion `eta_squared()` nutzen. Wir wollen dann noch das [generalisierte Eta$^2$](https://easystats.github.io/effectsize/articles/anovaES.html#generalized-eta2) nutzen, da wir die Zeitpunkte nur beobachten und nicht als experimentellen Faktor festgelegt haben.
