...
#| fig-height: 5
#| fig-width: 5
#| fig-cap: "Korrelationsabbildungen der Lags über die Zeit für die Milchdaten. Wir sehen eine klarn zyklischen Verlauf, die sich über die Zeit ausdehnt. Das macht ja auch Sinn, den die Milchleistung wird auch von den Jahreszeiten abhängen. Bitte bachte, dass Lag 1.0 *nicht* das erste Lag beschreibt. Bei der partziellen Korrelation beobachten wir, dass wir ebenfalls einen kurvigen Verlauf vorliegen haben."
#| fig-subcap: 
#|   - "Correlogram."
#|   - "Partial Correlogram."
#| layout-nrow: 1
...
Trend: Modeled using as.numeric(date) Seasonal: Modeled using month(date)
