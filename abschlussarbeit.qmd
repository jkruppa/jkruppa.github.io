...
Hier findest sich eine aktuelle Struktursammlung für die Bachelorarbeit in der Bio Data Science. *Hier findest du keine Themen*. Dafür musst du mich bitte ansprechen oder eine E-Mail schreiben. Die Themen finden sich dann etwa mit Kooperationspartern oder aber eher methodisch ohne echte Daten. Das müssen wir dann aber Absprechen. Eins ist aber sicher, Experimente zur Datengenerierung mache ich keine.

Bitte halte Rücksprache, wenn dir Teile der Regeln für die Bachelorarbeit unklar sind. Im Weiteren hilft auch der [Leitfaden zur Erstellung einer wissenschaftlichen Arbeit (7. Auflage)](https://github.com/jkruppa/jkruppa.github.io/blob/master/module/Leitfaden%207.%20Auflage.pdf) der Hochschule Osnabrück. Der Leitfaden bietet dir auch eine Übersicht und Ideen für die Struktur der Arbeit. Schaue doch auch da mal rein.

-   Die Bachelorarbeit umfasst einen Zeitraum von 12 Wochen. Bei Unsicherheit über das Thema kann einmalig eine 4-wöchige bis 6-wöchige Einarbeitungsphase vereinbart werden. Danach wird das Thema der Bachelorarbeit bei der Anmeldung konkretisiert.
-   Der Umfang sollte die 60 Seiten nicht überschreiten.
-   Die Arbeit umfasst ca. 40 bis 50 Referenzen, davon sind die meisten aktuelleren Datums. Internetseiten zählen nicht als Referenz.
-   Im Rahmen der Betreuung deiner Bachelorarbeit finden jede Woche ein unverbindliches Zoom-Treffen statt in dem der aktuelle Fortschritt der Arbeit besprochen wird.
-   In der 4-ten Woche wird eine kurze Präsentation der bisherigen erarbeiteten Inhalte gegeben. Diese Präsentation *kann* in der 8-ten Woche erneut erfolgen, wenn noch Fragen offen sind. Meistens erfolgt nur eine Präsentation in der 4 Woche.

Damit du deinen Schreibprozess etwas nachvorfolgen kannst, kannst du dir folgende Daumenregel merken. Da du am Ende auf ca. 60 Seiten kommen sollst und bei zwölf Wochen Zeit für die Bearbeitung, kommst du ca. auf eine Seite Bachelorarbeit pro Werktag. Daher solltest du schauen, dass du immer nebenbei eine Seite Inhalt produzierst. Also ein 8 Stunden Arbeitstag führt zu einer Seite Bachelorarbeit.
