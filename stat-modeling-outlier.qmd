...
In der @tbl-flea-1 ist der Datensatz `flea_tbl` nochmal dargestellt.

```{r}
#| message: false
#| echo: false
#| tbl-cap: "Auszug aus dem Datensatz `flea_tbl`. Wir betrachten die ersten sieben Zeilen des Datensatzes."
#| label: tbl-flea-1
...
In der @tbl-longnose-1 ist der Datensatz `longnose_tbl` nochmal dargestellt.
...
In der @tbl-gummi-1 ist der Datensatz `gummi_tbl` nochmal dargestellt.
