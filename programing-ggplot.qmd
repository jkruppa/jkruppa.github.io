...
| 10\. | [R Paket`{emo}`](https://github.com/hadley/emo) | Eine Möglichkeit |
| 11\. | [R Paket `{ggpp}`](https://docs.r4photobiology.info/ggpp/index.html) |  |
| 12\. | [R Paket `{ggsignif}`](https://github.com/const-ae/ggsignif) |  |
|  |  |  |
