...
![Zusamenhang zwischen $y$ sowie dem Index $i$ in der Formel für den Mittelwert.](images/index-drawn.png){#fig-index-drawn fig-align="center" width="80%"}
...
Wenn wir die Summe der Abweichungen von $y_1$ bis $y_5$ zu dem Mittelwert bilden, so wird diese Summe 0 sein. Der Mittelwert liegt genau in der Mitte der Punkte. In unserem Beispiel ist der Mittelwert $\bar{y} = 5.8$. Wi können jetzt die Abstände wie in der folgenden @tbl-y-mean-variance berechnen.
