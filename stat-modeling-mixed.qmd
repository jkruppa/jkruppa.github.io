...
Jetzt wollen wir nochmal schauen, ob wir auch eine Interaktion zwischen der Stickstoffdüngung, den Weizensorten und den Blöcken vorliegen haben. Insbesondere
...
gg_inter_template %+% 
  stat_oats_tbl + 
  aes(x = nitro, y = mean, color = gen, group = gen) +
...
gg_inter_template %+% 
  stat_oats_tbl + 
  aes(x = nitro, y = mean, color = block, group = block) +
  labs(x = "Stickstoffkonzentration", y = "Ertrag", color = "Block") +
  facet_wrap(~ gen) 
```
