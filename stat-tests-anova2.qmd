...
Jetzt bietet es sich an nochmal den Zusammenhang von $MS_A$ und $MS_{Error}$ in der folgenden @fig-ggplot-anova-msa-mse näher zu betrachten. Wir können ja kleine Werte oder große Werte für die mittleren Abweichungsquadrate der lokalen Mittelwerte zum globalen Mittelwert $MS_A$ vorliegen haben. Ebenso können die mittlere Abweichungsquadrate der Beobachtungen zu den jeweiligen Gruppenmittewerten $MS_{Error}$ klein oder groß sein.
