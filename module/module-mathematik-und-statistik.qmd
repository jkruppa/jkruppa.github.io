...
-   Die Studierenden sind in der Lage mathematische Formeln in der Litertaur zu finden.
...
Die Studierenden sind in der Lage einfache lineare und exponentielle Kosten- und Nutzenabschätzungen anhand von mathematischen Modellen durchzuführen. Diese einfachen Abschätzungen umfassen die Planung von technischen Verbrauchsprozesses in den Pflanzenwissenschaften sowie in der Landwirtschaft. Die Studierenden können dabei externe Literaturquellen und deren statistischen Maßzahlen in den Kontext des eigenen Berufsfeld setzen und aus verschiedenen, wissenschaftlichen Quellen erste informierte Vorentscheidungen treffen. Die Studierenden sind in der Lage bei der Erstellung von Daten aus Experimenten die Verwertbarkeit in R zu berücksichtigen. Das Konzept von "tidy data" wird von den Studierenden umgesetzt.

##### Wissenschaftliche Innovation

als auch Forschungskontexte

#### Kommunikation und Kooperation

Die Studierenden sind durch das Konzept von "tidy data" in der Lage erhobene Daten mit anderen Forschenden zu teilen. Ebenfalls sind die Studierenden in der Lage gängige statistische Maßzahlen zu erkennen und zu berichten. Die Studierenden können einfachen R Code lesen und demonstrieren.
