...
Eine andere große Baustelle und auch ein Teil, den ich noch schreiben möchte, ist der Bereich genetische Analysen in der Bioinformatik. Aber dieses Thema wird dann das [Skript Bioinformatik](https://jkruppa.github.io/bioinformatic/) werden. Genetische Analyse passen hier definitiv nicht mehr rein. Ich werde aber wirklich eine Zeit brauchen, um dort "fertig" zu werden.
...
Ich hoffe du hast ähnlich viel gelernt wie ich, als ich das hier alles geschrieben habe.

Möge das Skript dir von Nutzen sein.
