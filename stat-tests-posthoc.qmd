...
Dann wissen wir jetzt wohin wir wollen. Jetzt stellt sich noch die Frage, welches statistisches Verfahren soll ich wählen um einen Gruppenvergleich zu rechnen? In der folgenden Box gebe ich dir da einmal einen Überblick. Abhängig von deinem Outcome oder deinen gemessenen Werten, mussst du dich fürm ein anderes Verfahren entscheiden. Es kann also sein, dass du verscheidene statistsiche Tests in deiner Abschlussarbeit rechnest, da du verschiede Outcomes statistsih analysierst.
...
Normalverteiltes Outcome: Frischgewicht, Trockengewicht, Chlorophyllgehalt...

:   Dann schaue dir den Abschnitt zu [Multiple Gruppenvergleiche für normalverteilte Daten](#sec-mult-comp-gaussian-reg) an.

Poissonverteiltes Outcome oder Zähldaten: Anzahl Insekten, gekeimte Pflanzen, Schädlinge...
...
Ordinalverteiltes Outcome: Bonitur von Rasen, Brokkolistängel, Wurzelwachstum...
...
Binomialverteiltes Outcome oder Anteile: Infektionsstatus, Zielgewicht...
