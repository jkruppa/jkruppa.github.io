...
::: callout-tip
## Anwendungsbeispiel: *\[zur Zeit offen\]*

![](images/caution.png){fig-align="center" width="50%"}

**Dieses Beispiel ist eine Baustelle und wird es vermutlich auch über Jahr 2024 bleiben. Ich warte aktuell noch auf ein passendes Anwendungsbeispiel aus der Beratung. Daher kann es also noch eine Weile dauern.**
:::
