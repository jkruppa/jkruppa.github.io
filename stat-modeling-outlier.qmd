...
-   Multivariate [Anomaly Detection](https://rpubs.com/Treegonaut/301942) mit dem R Paket [`{mvoutlier}`](https://cran.r-project.org/web/packages/mvoutlier/index.html)
:::
...
`{dlookr}` oder `{OutlierDetection}` sowie `{DMwR}`
:::
