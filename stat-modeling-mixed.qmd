...
lmer_3_fit <- lmer(test_score ~ body_length_cat + (site|mountain_range), data = dragons_tbl) 
...
compare_performance(lm_simple_fit, lm_mountain_fit, lmer_1_fit, lmer_2_fit,
                    lmer_3_fit, rank = TRUE)
```
