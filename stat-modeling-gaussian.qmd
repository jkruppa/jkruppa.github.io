...
Wir gehen jetzt einmal die lineare Regression mit einem normalverteilten Outcome $y$ einmal durch. Wie schon oben erwähnt, meistens nutzten wir die Gaussian Regression als vorrangestelltes Modell für eine ANOVA oder dann eben einen Posthoc-Test in `{emmeans}`.
