...
Es gibt in R mindestens zwei Mögochkeiten einen statistischen Gruppenvergleich zwischen zwei Gruppen zu rechnen. Zum einen die Standardimplementierung `{base}` jedes statistsichen Tests sowie die Nutzung des neuen R Paketes `{infer}`.
