...
Immer wenn ich mit Zeitreihen anfange, muss ich mich erinnern, dass die Algorithmen immer einer Vorhersage treffen wollen. Das heißt, wir wollen wissen wie sich eine Zeitreihe gegeben der vorherigen Ereignisse in der Zukunft verändern wird.
...
[R Paket {timetk}](https://business-science.github.io/timetk/)

### ... `{fable}` und `{feasts}`

[R Paket {fable}](https://fable.tidyverts.org/articles/fable.html) [R Paket {feasts}](https://feasts.tidyverts.org/index.html)
