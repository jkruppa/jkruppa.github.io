...
Was ist gute Literatur? Immer schwer zu beurteilen. Im Folgenden liste ich einige Literaturquellen auf. Zum einen basiert eine Menge von dem R Code auf Wickham [-@wickham2016r] und zum Anderen möchtest du dich vielleicht nochmal rechts oder links weiter bilden. Du musst aber nicht um die Klausur bestehen zu können. Siehe es eher als ein Angebot.

::: callout-caution
## Die Frage nach der Klausur...

Um es hier gleich zu Anfang zu sagen, es ist nicht notwendig mehr als die Teile des Skript durchzuarbeiten, die ich auch in der Vorlesung durchnehme und bei den Übungen zu sein um die Klausur zu bestehen. Für deine Abschlussarbeit wirst du aber Programmieren in R können müssen.
:::
