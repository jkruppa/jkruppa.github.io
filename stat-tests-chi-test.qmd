...
Den Test auf Anteile können wir nutzen, wenn wir eine beobachtete Wahrscheinlichkeit oder Anteil $p_1$ gegen eine gegebene Wahrscheinlichkeit oder Anteil $p_0$ vergleichen wollen.

$p_1 = \cfrac{x}{n} = \cfrac{76}{100} = 0.76 = 76\%$
...
$$
\chi^2_{calc} = \cfrac{(76 - 84)^2}{84} + \cfrac{(24 - 16)^2}{16} = 4.76
$$
