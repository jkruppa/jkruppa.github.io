...
Wir erhalten ein $W = 0.968$, was wir direkt als eine F-Statistik interpretieren können. Schauen wir uns das Ergegebnis einmal in der R Funktion `leveneTest()` aus dem R Paket `car` an. Wir brauchen dafür einmal die Werte für die Sprungweiten und müssen dann die Daten in das long-Format umbauen und dann rechnen wir den Levene-Test. Wir erhalten fast die numerisch gleichen Werte. Bei uns haben wir etwas gerundet und dann kommt die Abweichung zustande.
