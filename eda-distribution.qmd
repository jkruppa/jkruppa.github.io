...
Neben der Berechnung der Wanrscheinlichkeit rechts und links eines gegebenen Wertes $t$ können wir auch $t$ berechnen, wenn wir eine Fläche vorgeben. Das kann uns dann die Funktion `qt()` liefern. Wir sehen, dass mit steigender Fallzahl und damit steigenden Freiheitsgrad sich der berechntete Wert sich dem Wert der Standardnormalverteilung von $1.96$ für $p = 0.05$ annähert.
...
Wir würden je Farbe `r floor(nrow(count_bag_tbl)/6)` Gummibärchen erwarten.
