...
![Ursprüngliche Abbildung, die nachgebaut werden soll. Zwei lineare Regressionen mit den jeweiligen Regressionsgleichungen.](images/eda/zerforschen_green_tea_effect_01.png){#fig-zer-green-tea-01 fig-align="center" width="70%"}
...
```{r}
lm(fat_ox_r_kj_min ~ trt + time_fct + trt:time_fct, data = green_tea_tbl) |> 
...
![Ursprüngliche Abbildung, die nachgebaut werden soll. Zwei lineare Regressionen mit den jeweiligen Regressionsgleichungen.](images/eda/zerforschen_green_tea_effect_03.png){#fig-zer-green-tea-03 fig-align="center" width="70%"}
