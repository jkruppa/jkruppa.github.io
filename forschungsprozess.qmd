...
*Letzte Änderung am `r format(fs::file_info("forschungsprozess.qmd")$modification_time, '%d. %B %Y um %H:%M:%S')`*

> *"In der Wissenschaft beginnt alles Neue damit, dass jemand brummt 'Hmmm... ist ja komisch.'" --- Isaac Asimov*

Wenn du forschen willst und Neues herausfinden willst, musst du hinterfragen was dich an Welt und Realität umgibt. Du musst dich aus deiner Komfortzone herausbegeben und etwas Neues wagen. Beginnen wir also unvermittelt mit einer kleinen Parabel von @wallace2009water [über das Wasser](https://fs.blog/david-foster-wallace-this-is-water/).
...
![Quelle: @kawaler1981habitable](images/preface/herschel_02.png){#fig-herschel-2 fig-align="center" width="100%"}

![Quelle: @basalla2006civilized](images/preface/herschel_01.png){#fig-herschel-1 fig-align="center" width="100%"}
...
!["What is this 'perfume' you are selling?" "Vinegar in a bottle. It's the only thing around here that doesn't completely smell like poo ..." Quelle: wumo.com](images/preface/hygiene.jpg){#fig-wumo-hygiene fig-align="center" width="100%"}
...
!["This is a shit. Traditionally, something we all flock to. This conference asks the question: Why? Is it enviroment or genes? Or are we all just a bunch of idots?" Quelle: wumo.com](images/preface/conference.jpg){#fig-wumo-flies fig-align="center" width="100%"}
...
::: {#fig-halley layout-ncol="2" fig-align="center"}
![Hohlerde nach Halley. Quelle: wikepedia.org](images/preface/hohlerde.png){#fig-hohl-01 fig-align="center" width="100%"}

![Halley als Astronomer Royal. Quelle: wikepedia.org](images/preface/halleold.jpg){#fig-hohl-02 fig-align="center" width="100%"}
...
::: {#fig-cargo-overview layout-ncol="3" fig-align="center"}
...
![Bilder des Tages. Quelle: der-postillon.com](images/preface/cargo_cult_01.jpg){#fig-cargo-01 fig-align="center" width="100%"}

![Birds Arent't Real Kampagne. Quelle: nytimes.com](images/preface/cargo_cult_02a.png){#fig-cargo-02 fig-align="center" width="100%"}
...
!["After 40 years as a teacher, Gary McAdams finally manages to bore a student to death." Quelle: wumo.com](images/preface/teaching.png){#fig-wumo-teaching fig-align="center" width="100%"}
...
![](images/preface/future_science.jpeg){#fig-wumo-future-science fig-align="center" width="90%"}
...
Heinrich Böll schrieb zum Tage der Arbeit am 1. Mai 1963 die [Anekdote zur Senkung der Arbeitsmoral](https://jimdo-storage.global.ssl.fastly.net/file/9978e873-401b-4254-86aa-aa0dfb0d1086/Boell_Anekdote%20zur%20Senkung%20der%20Arbeitsmoral.pdf). Vermutlich kennst du schon die Geschichte an deren Ende der Fischer nichts gewinnen würde, wenn er sehr viel Arbeit und sich nicht der Faulenzerei hingibt, denn er hätte dann nicht mehr als er jetzt sowieso schön hätte. Auch sehr spannend zu lesen ist das Buch von @price2021laziness mit dem Titel *Laziness does not exist*. Ich fand einige der Gedanken sehr erhellend. Manachmal ist weniger dann auch mehr. Vor allem, wenn das mehr dann mehr von dem eigenen Leben beinhalten, was einen selber auch ausmacht.

Die Parabel hat unterschiedliche Rezeptionen erfahren. So diskutiert die Karrierebibel in dem Artikel [Warum die Parabel über den Fischer und Touristen gefährlich ist](https://karrierebibel.de/parabel-fischer-tourist/), ob die Parabel mehr nutzt als schadet. Oder ist es nicht eher so, dass das Verhalten des Touristen erst zur [Tragödie des Dorsches in der Ostsee](https://www.wwf.de/themen-projekte/projektregionen/ostsee/dorsch-in-der-ostsee) geführt hat? Wenn alle Fischer sich so Verhalten wie der Tourist vorschlägt, dann wird die Sache schon problematisch. Auch ist es ganz spannend mal zu hören, was so Tech-Milliardäre so denken. Wo sollen sie den die Bunker bauen? Höre dazu den Deutschlandfunk [Im Angesicht der Katastrophe -- Die Angst der Tech-Milliardäre vor ihrem Personal](https://www.deutschlandfunk.de/die-angst-der-tech-milliardaere-vor-ihrem-personal-100.html).
...
Im Folgenden siehst du in der @fig-feynman-example einmal zwei Beispiele für meinen Umgang mit neuen Ideen und Lehrstoff. Ich zeichne mir da auch immer wild Sachen in mein Buch und versuche mich darüber zu strukturieren.

::: {#fig-feynman-example layout-ncol="2"}
![Beispiel für die Erstellung des Skripts Bioinformatik. Erste Ideen für die Zeichnung der Übersicht.](images/preface/feynman_example_1.jpeg){#fig-surus}

![Beispiel für die Erstellung der experimentellen Designs Kapitels.](images/preface/feynman_example_2.jpeg){#fig-hanno}

Anwendung der Feynman-Methode in meinen eigenen Alltag der Lehre. Einmal der Versuch die Genetik für das zukünftige Skript Bioinformatik zu sortieren und einmal Ideen sowie Gedanken zum experimentellen Design Kapitel. Erkennt man im Endprodukt dann nicht wieder.
:::
