...
tibble(x = 0:10, y = 0:10) |> 
  ...
  annotate("label", x = 8.5, y = 4.4+1, label = expression(H[0]*":"~beta[weight]*"="*0), size = 3.5, 
           fontface = 1, fill =  "#009E73", alpha = 0.5, hjust = "left") +  
  annotate("label", x = 8.5, y = 3.8+1, label = expression(H[0]*":"~beta[count_leg]*"="*0), 
           size = 3.5, fontface = 1, fill =  "#009E73", alpha = 0.5, hjust = "left") + 
  annotate("label", x = 8.5, y = 3.2+1, label = expression(H[0]*":"~beta[count_leg]*"="*0), 
           size = 3.5, fontface = 1, fill =  "#009E73", alpha = 0.5, hjust = "left") + 
  annotate("label", x = 8.5, y = 2.6+1, label = expression(H[0]*":"~beta[count_leg]*"="*0), 
           size = 3.5, fontface = 1, fill =  "#009E73", alpha = 0.5, hjust = "left") + 
...
| Feeding | Stage | $\beta_0$ | $\beta_{blood}$ | $\beta_{ketchup}$ | $\beta_{juvenile}$ | $\beta_{blood \times juvenile}$ | $\beta_{ketchup \times juvenile}$ | $\boldsymbol{\bar{Y}}$ |
|----|----|----|----|----|----|----|----|----|
| sugar | adult | 78.98 |  |  |  |  |  | 78.9 |
| sugar | juvenile | 78.98 |  |  | -17.94 |  |  | 61.03 |
| blood | adult | 78.98 | 20.73 |  |  |  |  | 99.71 |
| blood | juvenile | 78.98 | 20.73 |  | -17.94 | 34.26 |  | 116.03 |
| ketchup | adult | 78.98 |  | 13.17 |  |  |  | 92.15 |
| ketchup | juvenile | 78.98 |  | 13.17 | -17.94 |  | 37.03 | 111.24 |
...
```{r}
cov1_fac1_fit <- lm(jump_length ~ feeding + weight, data = flea_model_tbl) 
```
