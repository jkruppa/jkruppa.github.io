...
In diesem Kochbuch findest du eine umfangreiche Sammlung an Rezepten aus den Bereichen Biostatistik, Biometrie, Statistik, Bio Data Science und R-Programmierung. Damit kannst du in diesen Fachgebieten tiefgreifende Kenntnisse für die Analyse von Daten erwerben, ohne an meinen Kursen teilnehmen zu müssen. Du bist herzlich eingeladen, hier und dort dich einzulesen, um zu sehen, ob etwas für dich von Interesse ist und um dir dann dein eigenes Menü zusammenzustellen. Seit einiger Zeit pausiert das hauptsächliche Schreiben hier, da ich meinen Fokus auf eine englische Version gelegt habe. Kleinere Korrekturen und Ergänzungen im Buch führe ich weiterhin durch. Ebenso ergänze ich die entsprechenden YouTube-Videos zu den Kapiteln.
...
*Kruppa-Scheetz, Jochen (`r year(today)`) Openbook Bio Data Science - Der endgültige Leitfaden, https://jkruppa.github.io/ (Zugriff am `r day(today)`. `r month(today, label = TRUE)`. `r year(today)`)*
:::
