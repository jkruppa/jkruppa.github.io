...
[Von dem Umfang von Bäumen](https://r4ds.github.io/bookclub-tmwr/r-formula-syntax.html)

Baumumfang `circumfence` gemessen in Zoll, Höhe `height` gemessen in Fuß und Volumen `volume` gemessen in Kubikfuß.
...
![Darstellung der Schnabellänge (eng. *bill length*) und der Schnabelhöhe (eng. *bill depth*) für die Pinguindaten.](images/penguins_culmen_depth.png){#fig-jumping-animal fig-align="center" width="100%"}
