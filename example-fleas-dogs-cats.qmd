...
sigma <- matrix(c(4, 4, 3, 3, 2,
                  4, 4, 3, 2, 3,
                  3, 3, 4, 3, 4,
                  3, 2, 3, 4, 1,
                  2, 3, 4, 1, 4), ncol=5, byrow = TRUE)

lab_tbl <- rbind(rmvnorm(n = 8, mean = c(40, 20, 10, 110, 50), sigma = sigma),
                 rmvnorm(n = 8, mean = c(30, 10, 5, 120, 70), sigma = sigma),
                 rmvnorm(n = 8, mean = c(20, 20, 5, 120, 20), sigma = sigma),
                 rmvnorm(n = 8, mean = c(40, 10, 10, 140, 20), sigma = sigma),
                 rmvnorm(n = 8, mean = c(20, 20, 15, 100, 15), sigma = sigma),
                 rmvnorm(n = 8, mean = c(30, 20, 15, 80, 15), sigma = sigma)) |> 
  as_tibble() |> 
  set_names(c("K", "Mg", "CRP", "Hb", "BSG")) |> 
  round(2)
```
