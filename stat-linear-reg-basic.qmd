...
#| fig-height: 4.5
#| fig-width: 8
#| fig-cap: "Annotierte Ausgabe der Funktion `summary()` aus einer linearen Modellanpassung mit der Funktion `lm()`. Die Ausgabe der Funktion teilt sich grob in drei informative Bereiche: i) Informationen zu den Residuen, ii) Informationen zu den Koeffizienten und iii) Informationen zu der Modelgüte. *[Zum Vergrößern anklicken]*"
