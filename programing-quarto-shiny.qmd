...
Auch hier möchte ich auf die beiden Cheat Sheets für R Quarto und R Shiny verweisen. Schau dir einmal das Cheat Sheet für das [Publish and Share with Quarto :: Cheatsheet](https://rstudio.github.io/cheatsheets/html/quarto.html) an sowie werfe mal einen Blick in das [Shiny :: Cheatsheet](https://rstudio.github.io/cheatsheets/html/shiny.html). Besonders das R Shiny Cheat Sheet gibt nochmal einen schönen Überblick über die ganzen Input Optionen. Schau da einfach mal als Inspiration drüber.
