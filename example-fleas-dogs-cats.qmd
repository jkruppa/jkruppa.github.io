...
p1 <- ggplot(bar, aes(x = feeding, y = jump_length, fill = stage)) +
  theme_minimal() +
  geom_boxplot() +
  scale_fill_okabeito() +
...
p2 <- ggplot(bar, aes(x = feeding, y = log(count_leg), fill = stage)) +
  theme_minimal() +
  geom_boxplot() +
  scale_fill_okabeito() +
  theme(legend.position = "top") +
...
p3 <- ggplot(bar, aes(x = feeding, y = bonitur, fill = stage)) +
  theme_minimal() +
...
sigma <- matrix(c(4, 4, 3, 3, 2,
                  ...
                  3, 3, 4, 3, 3,
                  3, 3, 3, 4, 3,
                  2, 3, 3, 3, 4), ncol=5, byrow = TRUE)

rbind(rmvnorm(n = 8, mean = c(1,2,3,4,5), sigma = sigma),
      rmvnorm(n = 8, mean = c(1,2,3,4,5), sigma = sigma),
      rmvnorm(n = 8, mean = c(1,2,3,4,5), sigma = sigma),
      rmvnorm(n = 8, mean = c(1,2,3,4,5), sigma = sigma),
      rmvnorm(n = 8, mean = c(1,2,3,4,5), sigma = sigma),
      rmvnorm(n = 8, mean = c(1,2,3,4,5), sigma = sigma)) |> 
...
x <- rmvnorm(n=500, mean=c(1,2,3,4,5), sigma=sigma)
colMeans(x)
var(x)
