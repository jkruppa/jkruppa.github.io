...
Die Parabel hat unterschiedliche Rezeptionen erfahren. So diskutiert die Karrierebibel [Warum die Parabel über den Fischer und Touristen gefährlich ist](https://karrierebibel.de/parabel-fischer-tourist/). Oder ist es nicht eher so, dass das Verhalten des Touristen erst zur [Tragödie des Dorsches in der Ostsee](https://www.wwf.de/themen-projekte/projektregionen/ostsee/dorsch-in-der-ostsee) geführt hat? Wenn alle Fischer sich so Verhalten wie der Tourist vorschlägt, dann wird die Sache schon problematisch.
