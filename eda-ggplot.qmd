...
[LaTeX Mathehilfe I](https://de.wikipedia.org/wiki/Hilfe:TeX) sowie [LaTeX Mathehilfe II](https://en.wikibooks.org/wiki/LaTeX/Mathematics)
...
Das R Paket `latex2exp` und die Funktion `TeX()` sowie
