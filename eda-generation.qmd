...
Der folgende Geanknegang ist eher etwas wild, aber er hilft vielleicht sich die Sachlage nochmal zu veranschaulichen. Rein statistisch gesehen überfhren wir hier einen statistischen Engel, aber so richtig. Mir hat es nochmal etwas geholfen eine Idee dafür zu entwicklen, was diese logistische Transfomation sein soll und wie diese stattfindet.
...
[Logistic regression (by hand)](https://maximilianrohde.com/posts/logistic-regresstion-by-hand/)

[Logistic Regression Explained from Scratch (Visually, Mathematically and Programmatically)](https://towardsdatascience.com/logistic-regression-explained-from-scratch-visually-mathematically-and-programmatically-eb83520fdf9a/)
