...
Oder du baust dir gleich die Abbildungen so wie die BBC mit dem Tutorium [How to create BBC style graphics](https://bbc.github.io/rcookbook/).
...
Du findest auf YouTube [Einführung in R - Teil 16.0 - Trockenübung ggplot2 simpel und einfach erklärt](https://youtu.be/SGwSVzJ9C-s) als Video. Sowie dann auch auf YouTube [Einführung in R - Teil 16.1 - Abbildungen mit ggplot in R erstellen. Idee und Konzept von ggplot](https://youtu.be/SRRQQO3DXtc) als Video. Also alles nochmal als Video - vielleicht einfacher nachzuvollziehen als in einem Fließtext.
:::
...
Schaue dir auch als Überblick einmal das [Data visualization with ggplot2 :: Cheat Sheet](https://rstudio.github.io/cheatsheets/html/data-visualization.html) an. Du kriegst dann nochmal ein Überblick über die `geom`e, die es gibt und wie die einzelnen Funktionen und Möglichkeiten miteinander interagieren. Du kannst dir das Cheat Sheet auch auf Deutsch runterladen.
:::
...
### Barplot oder Balkendiagramm oder Säulendiagramm {#sec-eda-barplot}
...
![](images/eda/cbbPalette.png){fig-align="center" width="80%"}
...
## Ein einfaktorieller Barplot

Fangen wir mit der @fig-ur-barplot einmal an. Wir haben hier ein Säulendiagramm mit *Compact letter display* vorliegen. Daher brauchen wir eigentlich gar nicht so viele Zahlen. Für jede der vier Behandlungen jeweils einmal einen Mittelwert für die Höhe der Säule sowie einmal die Standardabweichung. Die Standardabweichung addieren und subtrahieren wir dann jeweils von dem Mittelwert und schon haben wir die Fehlerbalken.

![Ursprüngliche Abbildung, die nachgebaut werden soll. Ein simples Säulendiagramm mit sehr für Farbblinde ungünstigen Farben. Es sind die Mittelwerte sowie die Standardabweichung durch die Fehlerbalken dargestellt.](images/eda/zerforschen_barplot_simple.png){#fig-ur-barplot fig-align="center" width="80%"}
...
Wir berechnen wie gewohnt die Mittelwerte und die Standardabweichungen.
...
Beachte im Besonderen den Abschnitt von weiter oben zu den [mathematischen Ausdrücken in den Achsenbeschriftungen](#sec-eda-tex).
...
#| fig-height: 5
#| fig-width: 6
#| fig-cap: "In `{ggplot}` nachgebaute Abbildung."

p <- ggplot(data = stat_tbl, aes(x = iodine, y = mean,
                            color = type)) +
  theme_bw() +
...
Und dann zum Abschluss nochmal die [nicht-lineare Regression](#sec-non-linear) um zu schauen welche Koeffizienten der Regression wir erhalten würden.

::: panel-tabset
## Nicht-lineare Regression für $KI$

Die Funktion `r2()` aus dem R Paket `performance`
...
Und dann wären wir schon fertig
:::

::: {.callout-note collapse="true"}
## Nicht-lineare Regression und zwei Achsen
...
::: {.callout-note collapse="true"}
## Eine Kalibrierungsgerade

![](images/caution.png){fig-align="center" width="50%"}

![Ursprüngliche Abbildung, die nachgebaut werden soll. Zwei nicht-lineare .](images/eda/zerforschen_regression_03.png){#fig-ur-regression-03 fig-align="center" width="80%"}
:::

::: {.callout-note collapse="true"}
## Ein zwei-faktorieller Barplot

![](images/caution.png){fig-align="center" width="50%"}

![Ursprüngliche Abbildung, die nachgebaut werden soll. Zwei nicht-lineare Regession](images/eda/zerforschen_barplot_complex_01.png){#fig-ur-barplot-02 fig-align="center" width="80%"}
:::

::: {.callout-note collapse="true"}
## Ein gekippter Barplot mit Zielbereich
