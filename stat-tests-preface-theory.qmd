...
bind_rows(truth_tbl,
  ...
  geom_curve(x = 98, y = 24, xend = 43, yend = 70,
             arrow = arrow(length = unit(0.01, "npc"), type = "closed"),
             curvature = 0.6, color = "black", linewidth = 0.5) +
  geom_curve(x = 96, y = 75, xend = 110, yend = 68,
             arrow = arrow(length = unit(0.01, "npc"), type = "closed"),
             curvature = -0.5, color = "black", linewidth = 0.5) +
  ...
  annotate("text", x = 60, y = 74, label = "Rückschluß", size = 5, fontface = 2) +
  annotate("text", x = 60, y = 68, label = expression(über~die~H[0]), 
           size = 5, fontface = 3) +
  ...
  geom_curve(x = 30, y = 40, xend = 35, yend = 21,
             arrow = arrow(length = unit(0.01, "npc"), type = "closed"),
             curvature = -0.2, color = "gray", linewidth = 0.5) +
  geom_curve(x = 20, y = 40, xend = 10, yend = 21,
             arrow = arrow(length = unit(0.01, "npc"), type = "closed"),
             curvature = 0.2, color = "gray", linewidth = 0.5) +
  ...
  annotate("text", x = 91, y = -1, label = "Testverteilung", size = 5, 
           fontface = 2) +
...
#| message: false
#| warning: false
#| label: fig-test-preface-theory-02
#| fig-align: center
#| fig-height: 7
#| fig-width: 7
#| fig-cap: "foo. *[Zum Vergrößern anklicken]*"
...
bind_rows(truth_tbl,
  ...
  #theme_minimal() +
  geom_jitter(aes(fill = color, shape = shape), size = 4, width = 5, height = 5) +
  annotate("text", x = 58, y = 54, label = "Randomisierung", size = 5, fontface = 2) +
  annotate("text", x = 58, y = 52, label = "(Strukturgleichheit)", size = 5, fontface = 3) +
  ...
  geom_curve(x = 91, y = 16, xend = 33, yend = 4,
             arrow = arrow(length = unit(0.01, "npc"), type = "closed"),
             curvature = -0.6, color = "black", linewidth = 0.5) +
  geom_curve(x = 91, y = 31, xend = 91, yend = 22,
             arrow = arrow(length = unit(0.01, "npc"), type = "closed"),
             curvature = -0.1, color = "black", linewidth = 0.5) +
  annotate("text", x = 20, y = 52, label = "Grundgesamtheit", size = 5, fontface = 2) +
  geom_ellipse(aes(x0 = 20, y0 = 25, a = 22, b = 25, angle = 0), color = "black") +
  annotate("text", x = 93, y = 45, label = "Stichprobe", size = 5, fontface = 2) +
  annotate("text", x = 93, y = 43, label = "Daten (D)", size = 5, fontface = 3) +
  geom_ellipse(aes(x0 = 91, y0 = 36, a = 7, b = 5, angle = 0), color = "black") +
  annotate("text", x = 91, y = 66-45, label = "Teststatistik", size = 5, fontface = 2) +
  annotate("label", x = 91, y = 17, label = expression(T[D]), size = 7) +
  annotate("text", x = 58, y = 2, label = "Rückschluß", size = 5, fontface = 2) +
  annotate("text", x = 58, y = -2, label = expression(über~die~H[0]), 
           size = 5, fontface = 3) +
  scale_x_continuous(limits = c(-3, 100)) +
  scale_y_continuous(limits = c(-2, 54)) +
  scale_shape_manual(values = 21:24) +
  theme(legend.position = "none") +
  scale_fill_okabeito() 
