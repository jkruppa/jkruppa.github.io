...
[**Achtung** In der Regression wird uns auch wieder das $\beta$ als Symbol begegnen. Hier ist das $\beta$ ein Fehler in der *statistischen Testtheorie* in der Regression ist das $\beta$ ein Koeffizient der Regression. Hier ist der Kontext wichtig.]{.aside}
