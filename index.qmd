...
4)  [Räumliche Daten](#sec-spatial-data)
5)  [Metaanalysen](#sec-meta)
6)  [Lineare Regression by hand](#sec-modeling-simple-stat)
7)  [Marginal Models und `{emmeans}` mit mehr Theorie](#sec-posthoc)
8)  [Das R Paket `{correlation}` ergänzen](#sec-lin-reg-corr)
9)  [Ergänzen von Dashboard und Typst zu Quarto](#sec-quarto-shiny)
10) Maximum Likelihood als Methode ergänzen
