...
@matthews2000storks [Storks Deliver Babies (p = 0.008)](https://www.researchgate.net/profile/Robert-Matthews-2/publication/227763292_Storks_Deliver_Babies_p_0008/links/56f138d708aec9e096b316c9/Storks-Deliver-Babies-p-0008.pdf)
...
#| fig-height: 6
#| fig-width: 7
#| fig-cap: "Darstellung der Korrelation zwischen den Variablen in dm Storchendatensatz. Eine rote Einfärbung deutet auf eine positive Korrelation und eine blaue Einfärbung auf eine negative Korrelation hin."
cor_stork_res %>%
  summary(redundant = TRUE) %>%
  plot()
```
