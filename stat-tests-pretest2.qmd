...
#| fig-height: 8
#| fig-width: 8
#| fig-cap: "Theoretische Betrachtung von Quellen von heterogenen Varianzen in den zu vergleichenden Gruppen. **(A)** Vergleich zu einer negativen und positiven Kontrolle. Die Kontrollen haben unterschiedlich Varianzen **(B)** Vergleich verschiedener Zeitpunkte. Mit steigenden Werten und verstreichender Zeit steigende Mittelwerte und Varianzen. *[Zum Vergrößern anklicken]*"
...
1)  Du hast viele Behandlungsgruppen. Je mehr Gruppen du hast oder eben dann auch Faktorkombinationen, die du testen möchtest, desto wahrscheinlicher wird es, dass mindestens eine Gruppe eine unterschiedliche Varianz hat. Du hast Varianzheterogenität vorliegen.
