...
ggplot() +
  ...
  labs(color = "Baumwolllinie")
  
  
cotton_diff_tbl <- cotton_time_tbl %>% 
  pivot_wider(names_from = trt,
              values_from = height,
              names_prefix = "height_") %>% 
  mutate(diff = height_ctrl - height_genetic)
