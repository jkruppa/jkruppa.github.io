...
[Entgeltfreie Informationen - DWD-Website](https://www.dwd-shop.de/index.php/default/kostenfreie-informationen.html)

Hier findest du die [Informationen zu den Tages- und Monatswerten](https://www.dwd.de/DE/leistungen/klimadatendeutschland/beschreibung_tagesmonatswerte.html)

[Klimadaten für Deutschland](https://www.dwd.de/DE/leistungen/klimadatendeutschland/klimadatendeutschland.html#buehneTop)
...
#| fig-height: 9
#| fig-width: 9
#| fig-cap: "Konturplot der Minimum der Temperatur in 5 cm über dem Erdboden (TG), Minimum der Temperatur in 2 m über dem Erdboden (TN), Mittel der Temperatur in 2 m über dem Erdboden (TM) und Maximum der Temperatur in 2 m über dem Erdboden (TX)."
#| column: page
...
ggplot(weather_tbl, aes(month, day, z = grad)) +
  ...
  geom_hline(yintercept = c(5, 10, 15, 20, 25, 30), alpha = 0.9, linetype = 2)
