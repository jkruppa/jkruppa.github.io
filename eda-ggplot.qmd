...
Hier findest du die etwas komplexeren Beispiele, die ich oben nicht einordnen wollte, da es mehr verwirrt als hilft. In den Kapiteln zur Methode hinter den Abbildungen findest du die Beispiele nochmal.
...
::: {.callout-note collapse="true"}
## Zerforschen: Zweifaktorieller Barplot und Boxplot
