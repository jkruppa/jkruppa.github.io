...
In diesem Kapitel wollen wir uns mit den multiplen Vergleichen beschäftigen. Das heißt, wir wollen statistisch Testen, ob sich die Level eines Faktors voneinander unterscheiden.

In der @fig-zerforschen-papaya sehen wir ein Säulendigramm aus der wissenschaftlichen Veröffentlichung [Plant Growth, Yield, and Fruit Size Improvements in 'Alicia' Papaya Multiplied by Grafting](https://www.mdpi.com/2223-7747/12/5/1189).
...
In der @fig-zerforschen-hoverfly sehen wir ein Säulendigramm aus der wissenschaftlichen Veröffentlichung [Hoverfly pollination enhances yield and fruit quality in mango under protected cultivation](https://www.sciencedirect.com/science/article/pii/S0304423822004411).
...
::: callout-note
## Welches statistisches Verfahren für welchen Gruppenvergleich?

-   [Multiple Gruppenvergleiche für normalverteilte Daten](#sec-mult-comp-gaussian-reg)
-   [Multiple Gruppenvergleiche für Zähldaten](#sec-mult-comp-pois-reg) -- daher ist dein Outcome in dem wir zählen.
-   [Multiple Gruppenvergleiche für Boniturdaten](#sec-mult-comp-ord-reg)
-   [Multiple Gruppenvergleiche für Anteile](#sec-mult-comp-log-reg) -- daher ist dein Outcome $0/1$ kodiert.
-   [Multiple Gruppenvergleiche für gemischte Modelle](#sec-mult-comp-lmer-reg) oder Auswertungen mit 3 oder mehr Faktoren.
:::
