...
[R Paket `{afex}`](https://github.com/singmann/afex)
...
pacman::p_load(tidyverse, magrittr, broom, WRS2, scales,
               ...
               interactions, effectsize, conflicted)
...
fac2_id_tbl <- fac2_tbl |> 
  rowid_to_column(".id")

fac2_id_tbl <- fac2_tbl |> 
  mutate(.id = row_number())

aov_car(jump_length ~ animal + site + animal:site + Error(.id), data = fac2_id_tbl) 
