...
```{r echo = TRUE}
#| message: false
pacman::p_load(tidyverse, magrittr, dlookr, broom.helpers,
...
*Leider will seit neustem der Boruta Algorithmus nicht sauber laufen. Daher hier einmal Pause und nur der Code ohne Ausgabe.*
...
```{r}
#| eval: false
boruta_output <- Boruta(infected ~ age + sex + location + activity + crp + weight + creatinin,  
                        data = pig_tbl)  
