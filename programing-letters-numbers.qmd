...
![Ein leerer `tibble`.](images/programing/schrank/schrank_empty.png){#fig-tibble-empty fig-align="center" width="50%"}

![Ein `tibble` mit drei Variablen](images/programing/schrank/schrank_full.png){#fig-tibble-full fig-align="center" width="50%"}
