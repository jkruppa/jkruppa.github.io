...
In diesem Kapitel wollen wir uns mit der Grundlage der multiplen linearen Regression beschäftigen. Das heist wir schauen uns Modelle mit mehrern $x$ an. Wir haben also nicht mher nur eine Einflussvariable auf der rechten Seite der Gleichung sondern meist mehrere. Je nachdem wie diese $x$ beschffen sind, müssen wir die $x$ auch interpretieren. Wir unterscheiden in vier Arten von $x$.
