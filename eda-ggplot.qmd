...
#| echo: true
#| warning: false
#| label: fig-ggplot-zerforschen-regression-3
#| fig-align: center
#| fig-height: 4
#| fig-width: 7
...
grid::grid.text(TeX(r"($y = -98.41 \cdot x^2 + 432.09 \cdot x;\; R^2 = 0.957$)"), 
                x = 0.2, y = 0.2, just = "left", gp = grid::gpar(col = cbbPalette[2]))
grid::grid.text("text2", x = 0.65, y = 0.2, gp = grid::gpar(col = cbbPalette[3]))
```

Mit template und patchwork? Zwei oder drei tabs erstellen.
