...
2)  [Fragebogenanalyse als ein Kapitel schreiben](#sec-modeling-survey)
3)  [Modellieren in R als Einstiegskapitel erstellen](#sec-modeling-R)
4)  [Marginal Models und `{emmeans}` mit mehr Theorie](#sec-posthoc)
5)  [Ergänzen von Dashboard und Typst zu Quarto](#sec-quarto-shiny)
6)  [Interrater-Reliabilität ergänzen](#sec-effect-interrater)
7)  Maximum Likelihood als Methode ergänzen
8)  [Räumliche Daten](#sec-spatial-data)
9)  [Metaanalysen](#sec-meta)
10) [Überlegen wie `ggplot2 extensions` sinnvoll eingebaut werden können](https://exts.ggplot2.tidyverse.org/index.html)
11) [Teacup giraffe anschauen](https://tinystats.github.io/teacups-giraffes-and-statistics/index.html)
