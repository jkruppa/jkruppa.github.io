...
pacman::p_load(tidyverse, readxl, latex2exp, see, duke, 
               ...
               tidyplots, ggh4x, ggtext, gganimate, conflicted)
```
...
```{r}
ggplot_tbl$feeding |> levels()
```

```{r}
ggplot_tbl$feeding |> fct_relevel("blood") |> levels()
```

[Cheat sheet `{forcats}`](https://raw.githubusercontent.com/rstudio/cheatsheets/main/factors.pdf)

### `{ggrepel}`

[R Paket `{ggrepel}`](https://cran.r-project.org/web/packages/ggrepel/vignettes/ggrepel.html)

[Beispiele für `{ggrepel}`](https://ggrepel.slowkow.com/articles/examples.html)
...
#| fig-height: 4
#| fig-width: 7
#| fig-cap: "fff *[Zum Vergrößern anklicken]*"
...
[R Paket `{ggh4x}`](https://teunbrand.github.io/ggh4x/articles/ggh4x.html)
...
[R Paket `{ggtext}`](https://wilkelab.org/ggtext/)

`element_markdown()` mit [Markdown theme elements](https://wilkelab.org/ggtext/articles/theme_elements.html)

[Plotting with markdown text](https://wilkelab.org/ggtext/articles/plotting_text.html)
...
[R Paket `{ggpp}`](https://docs.r4photobiology.info/ggpp/index.html)

### `{ggsignif}`

[R Paket `{ggsignif}`](https://github.com/const-ae/ggsignif)
...
[R Paket `{ggpmisc}`](https://cran.r-project.org/web/packages/ggpmisc/vignettes/user-guide.html)
