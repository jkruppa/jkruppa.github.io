...
ggplot(data.frame(x = c(-3.25, 3.25)), aes(x)) +
  ...
  scale_x_continuous(breaks = c(-1.6, 0, 1.6, 2.4), 
                     labels = c(expression(-T[k]), 
                                ...
                                expression(+T[k]),
                                expression(T[calc]))) +
  annotate("text", x = 0, y = 0.2, label = expression(95*'%'), size = 14,
           color = "#E69F00") +
  annotate("text", x = -2.5, y = 0.15, label = expression(-T[alpha==5*'%']), size = 6,
           color = "#CC79A7") +
  annotate("text", x = 2.5, y = 0.15, label = expression(T[alpha==5*'%']), size = 6,
           color = "#CC79A7") +
  geom_curve(x = -2.5, y = 0.13, xend = -1.65, yend = 0.05,
