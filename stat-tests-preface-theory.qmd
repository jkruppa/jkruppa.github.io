...
pacman::p_load(tidyverse, readxl, knitr, kableExtra, broom,
               see, patchwork, ggbeeswarm, ggforce)
```
...
bind_rows(truth_tbl,
  ...
  geom_curve(x = 36, y = 90, xend = 85, yend = 89,
             arrow = arrow(length = unit(0.03, "npc"), type = "closed"),
             curvature = -0.5, color = "black", linewidth = 1) +
  geom_curve(x = 85, y = 75, xend = 42, yend = 70,
             arrow = arrow(length = unit(0.03, "npc"), type = "closed"),
             curvature = -0.5, color = "black", linewidth = 1) +
  geom_ellipse(aes(x0 = 20, y0 = 70, a = 22, b = 29, angle = 0), color = "black") +
  geom_ellipse(aes(x0 = 91, y0 = 82, a = 12, b = 8, angle = 0), color = "black") +
