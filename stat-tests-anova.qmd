...
|    dog     |      $8.2$      |           $4.74$            |  $(4.74 - 7.34)^2 = 6.76$  |     $(8.2 - 4.74)^2$      |  $(8.2 - 7.34)^2 = 0.74$  |
|    dog     |      $5.6$      |           $4.74$            |  $(4.74 - 7.34)^2 = 6.76$  |     $(5.6 - 4.74)^2$      |  $(5.6 - 7.34)^2 = 3.03$  |
|    dog     |      $9.1$      |           $4.74$            |  $(4.74 - 7.34)^2 = 6.76$  |     $(9.1 - 4.74)^2$      |  $(9.1 - 7.34)^2 = 3.10$  |
|    dog     |      $7.6$      |           $4.74$            |  $(4.74 - 7.34)^2 = 6.76$  |     $(7.6 - 4.74)^2$      |  $(7.6 - 7.34)^2 = 0.07$  |
|    cat     |      $3.2$      |           $8.13$            |  $(8.13 - 7.34)^2 = 0.62$  |     $(3.2 - 8.13)^2$      | $(3.2 - 7.34)^2 = 17.14$  |
|    cat     |      $2.2$      |           $8.13$            |  $(8.13 - 7.34)^2 = 0.62$  |     $(2.2 - 8.13)^2$      | $(2.2 - 7.34)^2 = 26.42$  |
|    cat     |      $5.4$      |           $8.13$            |  $(8.13 - 7.34)^2 = 0.62$  |     $(5.4 - 8.13)^2$      |  $(5.4 - 7.34)^2 = 3.76$  |
|    cat     |      $4.1$      |           $8.13$            |  $(8.13 - 7.34)^2 = 0.62$  |     $(4.1 - 8.13)^2$      | $(4.1 - 7.34)^2 = 10.50$  |
|    cat     |      $4.3$      |           $8.13$            |  $(8.13 - 7.34)^2 = 0.62$  |     $(4.3 - 8.13)^2$      |  $(4.3 - 7.34)^2 = 9.24$  |
|    cat     |      $7.9$      |           $8.13$            |  $(8.13 - 7.34)^2 = 0.62$  |     $(7.9 - 8.13)^2$      |  $(7.9 - 7.34)^2 = 0.31$  |
|    cat     |      $6.1$      |           $8.13$            |  $(8.13 - 7.34)^2 = 0.62$  |     $(6.1 - 8.13)^2$      |  $(6.1 - 7.34)^2 = 1.54$  |
|    fox     |      $7.7$      |           $9.16$            |  $(9.16 - 7.34)^2 = 3.31$  |     $(7.7 - 9.16)^2$      |  $(7.7 - 7.34)^2 = 0.13$  |
|    fox     |      $8.1$      |           $9.16$            |  $(9.16 - 7.34)^2 = 3.31$  |     $(8.1 - 9.16)^2$      |  $(8.1 - 7.34)^2 = 0.58$  |
|    fox     |      $9.1$      |           $9.16$            |  $(9.16 - 7.34)^2 = 3.31$  |     $(9.1 - 9.16)^2$      |  $(9.1 - 7.34)^2 = 3.10$  |
|    fox     |      $9.7$      |           $9.16$            |  $(9.16 - 7.34)^2 = 3.31$  |     $(9.7 - 9.16)^2$      |  $(9.7 - 7.34)^2 = 5.57$  |
|    fox     |     $10.6$      |           $9.16$            |  $(9.16 - 7.34)^2 = 3.31$  |     $(10.6 - 9.16)^2$     | $(10.6 - 7.34)^2 = 10.63$ |
|    fox     |      $8.6$      |           $9.16$            |  $(9.16 - 7.34)^2 = 3.31$  |     $(8.6 - 9.16)^2$      |  $(8.6 - 7.34)^2 = 1.59$  |
|    fox     |     $10.3$      |           $9.16$            |  $(9.16 - 7.34)^2 = 3.31$  |     $(10.3 - 9.16)^2$     | $(10.3 - 7.34)^2 = 8.76$  |
...
Der kritische F Wert $F_{\alpha = 5\%}$ lautet für die einfaktorielle ANOVA in diesem konkreten Beispiel mit $F_{\alpha = 5\%} = `r round(qf(p=.05, df1=2, df2=18, lower.tail=FALSE), 2)`$.
