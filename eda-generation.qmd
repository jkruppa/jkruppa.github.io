...
[Simulate data from a logistic regression model: How the intercept parameter affects the probability of the event](https://blogs.sas.com/content/iml/2023/01/16/simulate-logistic-intercept.html)
...
Der folgende Gedankengang ist eher etwas wild, aber er hilft vielleicht sich die Sachlage nochmal zu veranschaulichen. Rein statistisch gesehen überfahren wir hier einen statistischen Engel, aber so richtig. Mir hat es aber nochmal geholfen eine Idee dafür zu entwicklen, was diese logistische Transfomation sein soll und wie diese stattfindet.

```{r}
cov1_binary_logit_dt <- 
  cov1_binary_dt |> 
