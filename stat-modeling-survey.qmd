...
Ich bin kein Experte für die Untiefen der Fragebogenerstellung an der Hochschule Osnabrück. Hier empfehle ich auf jeden Fall nochmal eine Beratung im Team von [Prof. Dr. Ulrich Enneking](https://www.hs-osnabrueck.de/prof-dr-ulrich-enneking) oder [Prof. Dr. Matthias Kussin](https://www.hs-osnabrueck.de/prof-dr-matthias-kussin/). Hier in diesem Kapitel kannst du dann die Einführung lesen und erste Ideen für deine Fragebogenanalyse sammeln.
:::
...
#| fig-width: 10
#| fig-cap: "."
plot(correlation(corr_gummi_tbl, partial = TRUE)) +
...
::: callout-note
## Beratung für Lime Survey

Ich bin kein Experte die Fragebogenerstellung mit Lime Survey. Hier empfehle ich auf jeden Fall nochmal eine Beratung im Team von [Prof. Dr. Ulrich Enneking](https://www.hs-osnabrueck.de/prof-dr-ulrich-enneking). Dort liegen auf jeden Fall mehr Informationen zur Anwendung von Lime Survey wie auch eine Klickanleitung sowie Tipps & Tricks vor. Einfach einmal dort bitte nachfragen.
:::
