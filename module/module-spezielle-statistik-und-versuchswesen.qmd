...
-   Einführung in die gängigen multiplen Regressionen beinhaltend die logistische und multinomiale Regression, die Poissonregression sowie die klassische Gaussianregression.
-   Grundlagen der statistischen Maßzahlen der Modellgüte einer Regression sowie deren Effektschätzer.
-   Grundlagen der Variablenselektion und Imputation von fehlenden Werten sowie Ausreißerdetektion und die Anwendung der Hauptkomponentenanalyse.
...
-   Die Studierenden sind in der Lage aus englischen Tutorien statistische Analyseschritte für die eigenen Daten zu entwickeln.
-   Die Studierenden sind in der Lage aus englischen Internetquellen eine Lösung für ein R Problem zu finden.
...
-   Die Studierenden können komplexere experimentelle Designs in R visualisieren.
...
Die Studierenden sind in der Lage Kosten- und Nutzenabschätzungen anhand von statistischen Modellen und deren Effektschätzern durchzuführen. Diese Abschätzungen umfassen die Planung von technischen und biologischen Prozesses in den Agrarwissenschaften. Die Studierenden sind in der Lage verschiedene technische Prozesse gegeneinander zu vergleichen und eine Aussage über die Nichtunterlegenheit oder den statistischen Unterschied zu treffen. Die beiden gegensätzlichen Konzepte von einem geplanten Experiment und einer technischen Nichtunterlegenheit können von den Studierenden unterschieden werden. Die Studierenden sind in der Lage selbständig Datenanalysen in R durchzuführen.

##### Wissenschaftliche Innovation

Die Studierende können statistische Maßzahlen aus wissenschaftlichen Publikationen in andere wissenschaftliche Kontexte sicher einordnen. Die Studierenden sind in der Lage wissenschaftlich zu Arbeiten und eine Fragestellung in einen wissenschaftlichen Erkenntnisprozess zu übersetzen. Die Studierenden können statistische Auswertungen aus wissenschaftlichen Publikationen verstehen und informierte Forschungsideen entwickeln. Die Studierenden sind in der Lage bei der Erstellung von Daten aus Experimenten die Verwertbarkeit in R zu berücksichtigen. Die Studierenden können über die Erstellung von automatisierten Berichten die Reproduzierbarkeit der eigenen Ergebnisse gewährleisten.

#### Kommunikation und Kooperation

Die Studierenden sind in der Lage durch das Konzept der automatisierten Berichtserstattung durchgeführte Experimente und statistische Auswertungen mit anderen Forschenden zu teilen.

Mit anderen im multidiziplinären Team teilen

Ebenfalls sind die Studierenden in der Lage gängige statistische Maßzahlen zu erkennen und zu berichten. Die Studierenden können R Code lesen, erstellen und demonstrieren.

#### Wissenschaftliches Selbstverständnis / Professionalität

Die Studierenden können wissenschaftliche Publikationen und deren statistischen Maßzahlen in den Kontext des eigenen Berufsfeld setzen und informierte Entscheidungen treffen.
