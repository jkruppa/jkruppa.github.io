...
Wir setzen also den Wert $\chi^2_{calc}$ direkt in die Formel ein. Wir wissen ja auch, dass wir $n = 65$ Tiere untersucht haben. Da wir eine 2x2 Kreuztabelle vorliegen haben, haben wir $r = 2$ und $c = 2$ und somit ist das Minimum von $r-1$ und $c-1$ gleich $1$. Wir erhalten ein Cramers $V$ von $0.14$ was für einen schwachen Effekt spricht. Wir können uns auch grob an der folgenden Tabelle der Effektstärekn für Carmers $V$ orientieren.

|             | schwach | mittel | stark |
|-------------|---------|--------|-------|
| Cramers $V$ | 0.1     | 0.3    | 0.5   |

Zum anderen ahebn wir noch die Möglichkeit ddie Odds Ratios oder das Chancenverhältnis zu berechnen. Die. Odds Ratios lassen sich direkt als Effekt interpretieren haben aber den Nachteil, dass wir die Odds Ratios nur auf einer 2x2 Kreuztabelle berechnen können.
