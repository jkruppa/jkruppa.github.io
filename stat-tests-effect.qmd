...
@maclure1987misinterpretation [Misinterpretation and misuse of the kappa statistic](https://citeseerx.ist.psu.edu/document?repid=rep1&type=pdf&doi=63e3fc4cf928bc0a12f6c62cace8d94aee34db62) kappa statistik

[Funktion `relInterIntra()`](https://rdrr.io/cran/irr/man/relInterIntra.html)

[Inter-rater-reliability and Intra-class-correlation](http://dwoll.de/rexrepos/posts/interRaterICC.html)

[Inter-rater reliability](https://www.andywills.info/rminr/irr.html)

[Inter-Rater Agreement Chart in R](https://www.datanovia.com/en/lessons/inter-rater-agreement-chart-in-r/)

[R Paket `{irr}`](https://cran.r-project.org/web/packages/irr/irr.pdf)

### Cohen's Kappa auf einer 2x2 Kreuztabelle
...
: Eine 2x2 Tabelle als Beispiel. {#tbl-2x2-kappa}
...
Die ungewichtete Version entspricht dem Cohen's Kappa, mit dem wir uns in diesem Kapitel beschäftigen. Das gewichtete Kappa sollte nur für ordinale Variablen betrachtet werden und wird weitgehend in Kapitel
...
Die Funktion `xtabs()` hilft dir aus zwei oder mehr Spalten eine Kreuztabelle zu bauen.
...
Faustregel Cohen's Kappa $\kappa$

:   Die Diagonale von links oben nach rechts unten zeigt die Übereinstimmungen. Die Diagonale von links unten nach rechts oben zeigt die Nichtübereinstimmung.
...
Das Ganze geht natürlich nicht nur für zwei Level (ja/nein) sondern dann in R auch für mehrere Level

### Cohen's Kappa für mehr als zwei Bewerter
...
```{r}
kappam.light(diagnoses[1:5, 1:3])
```
...
[Intraclass Correlation Coefficient in R](https://www.datanovia.com/en/lessons/intraclass-correlation-coefficient-in-r/)
