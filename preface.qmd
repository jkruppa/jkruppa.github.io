...
## Lernziel 2: Statistische Versuche verstehen
...
dog_fleas_tbl <- tibble(flea_count = c(15,15,15,15,15,15,15,15,15,15,15,15,15,14,14,14,14,14,
                                       14,14,14,16,16,16,16,16,16,16,16,
                                       13,13,13,12, 17,17,17,18,18,19),
                        flea_weight = round(rnorm(length(flea_count), 20, 4), 2)) 

write_csv(dog_fleas_tbl, "data/dog_fleas_hist.csv")

ggplot(dog_fleas, aes(x = flea_count)) + 
  geom_dotplot() +
  theme_bw() +
