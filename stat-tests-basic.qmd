...
Jetzt können wir einmal die Mittelwertsdifferenz und die gepoolte Standardabweichung aus den obigen Daten berechnen. Das machen wir dann für jeden der drei möglichen Vergleiche. Dann rechnen wir noch die Teststatistik eines Student t-Tests als statistischen Test um an die Teststatistik zu kommen.

| Vergleich |                  Mittelwertsdifferenz                   |        Gepoolte Standardabweichung        | Teststatistik |
|:---------:|:-------------------------------------------------------:|:-----------------------------------------:|:-------------:|
...
Der kritische Wert $T_{\alpha = 5\%} = `r t_k`$
...
p1 <- tibble(x = c(1, 2, 3), y = 8.13) |> 
  ...
  annotate("text", x = c(1.1, 2.1, 3.1), y = c(9.79, 8.31, 7.95)+0.6, label = c("A", "B", "BC"),
           size = 7, fontface = 2) +
  labs(x = "", y = "") +
  theme(legend.position = "none",
        axis.text.x = element_text(size = 16),
