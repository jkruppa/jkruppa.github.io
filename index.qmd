...
*Kruppa-Scheetz, Jochen (`r year(today)`) Openbook Bio Data Science - Der endgültige Leidfaden, https://jkruppa.github.io/ (Zugriff am `r abs(day(today)-sample(1:10, 1))`. `r month(today, label = TRUE)`. `r year(today)`)*
:::
