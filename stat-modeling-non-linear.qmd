...
pacman::p_load(tidyverse, magrittr, broom, nlraa,
...
[Multivariate Fractional Polynomials: Why Isn’t This Used More?](https://towardsdatascience.com/multivariate-fractional-polynomials-why-isnt-this-used-more-1a1fa9ead12c)

[Multivariable Fractional Polynomials (MFP)](https://mfp.imbi.uni-freiburg.de/)
...
ggplot(chicken_tbl, aes(age, weight)) +
  ...
  #geom_line(aes(y = predict(mfp_fit)), size = 1, color = "red") +
  geom_point() +
  theme_bw()
```
