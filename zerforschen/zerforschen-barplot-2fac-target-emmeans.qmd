...
![Ursprüngliche Abbildung, die nachgebaut werden soll. Ein Barplot mit den zwei zwei Faktoren Zeit und die Iodine Form.](images/eda/zerforschen_barplot_2fac.png){#fig-ur-barplot-02 fig-align="center" width="100%"}
...
#| fig-height: 4
#| fig-width: 7
#| fig-cap: "Die Abbildung des Säulendiagramms in `ggplot` nachgebaut. Wir nutzen das `geom_text()` um noch besser unser *compact letter display* zu setzen. Die Kontrolle wurde entfernt, sonst hätten wir hier nicht `emmeans` in der einfachen Form nutzen können."
