...
Oder du baust dir gleich die Abbildungen so wie die BBC mit dem Tutorium [How to create BBC style graphics](https://bbc.github.io/rcookbook/). Auch hier kann ich dir einmal die Übersicht der Seite [R Charts by R Coder](https://r-charts.com/) ans Herz legen. Auf der Seite findest du dann eine sehr große Übersicht an möglichen Abbildungen, sie ich hier unmöglich alle vorstellen kann!
