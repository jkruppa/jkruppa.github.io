...
#### Was ist ein Effekt? {.unnumbered .unlisted}
...
#| label: fig-gen-data-01


tibble(x = c(0,  1, 2, 3), y = 12) |> 
  ggplot(aes(x, y)) +
  theme_minimal() +
  geom_rect(aes(xmin = 0.8, xmax = 1.2, ymin = 0, ymax = 7), fill = "#E69F00",
            color = "black",  linewidth = 0.75) +
  geom_segment(x = 1, y = 7, xend = 1, yend = 10.27, color = "black",
               linewidth = 0.75, linetype = 1) +
  geom_segment(x = 0.9, y = 10.27, xend = 1.1, yend = 10.27, color = "black",
               linewidth = 0.75, linetype = 1) +
  geom_rect(aes(xmin = 0.8+1.25, xmax = 1.2+1.25, ymin = 0, ymax = 10), fill = "#56B4E9",
            color = "black",  linewidth = 0.75) +
  geom_segment(x = 1+1.25, y = 10, xend = 1+1.25, yend = 12.2, color = "black",
               linewidth = 0.75, linetype = 1) +
