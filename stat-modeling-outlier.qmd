...
data_tbl <- tibble(trt = c("dose", "ctrl", "ctrl", "ctrl", "dose", "dose"),
                   rsp = c(22.5, 19.5, 19.0, 24.5, 17.6, 14.6 ))

data_tbl |> 
  group_by(trt) |> 
  summarise(mean(rsp), var(rsp), sd(rsp))

t.test(rsp~trt, data_tbl)
