...
ggplot(data = fac2_tbl, 
  ...
  labs(x = "Sprungweite in [cm]", y = "", fill = "Tierart") +
  scale_fill_okabeito() +
  xlim(9, 32)
```
...
#| echo: true
#| warning: false
#| label: fig-ggplot-check-anova-normal-f2-1
#| fig-align: center
#| fig-height: 4
#| fig-width: 6
...
#| echo: true
#| warning: false
#| label: fig-ggplot-check-anova-normal-f2-2
#| fig-align: center
#| fig-height: 4
#| fig-width: 6
#| fig-cap: "Schnelle Abbildung der Residuen aus `check_normality()` zur Überprüfung der Normalverteilung des Messwerts in einem zweifaktoriellen Modell."
...
#| echo: true
#| warning: false
#| label: fig-ggplot-check-anova-variance-f2-1
#| fig-align: center
#| fig-height: 4
#| fig-width: 6
...
#| echo: true
#| warning: false
#| label: fig-ggplot-check-anova-variance-f2-2
#| fig-align: center
#| fig-height: 4
#| fig-width: 6
#| fig-cap: "Schnelle Abbildung der Residuen aus `check_homogeneity()` zur Überprüfung der Varianzhomogenität der Faktoren in einem zweifaktoriellen Modell."
...
trans_tbl <- read_csv2("data/flea_dog_cat_length_weight.csv") |>
