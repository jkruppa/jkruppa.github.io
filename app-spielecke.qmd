...
## Barplot mit $0.41\pm 0.03$ und $0.35\pm 0.03$

Mich hat dann einmal interessiert wie die Werte aus dem Text denn als Barplot aussehen würden. Deshalb hier einmal die Werte in einem `tibble()` um diese dann als einen Barplot abbilden zu können.
...
In der @fig-zerforschen-green-tea-01 siehst du einmal die beiden Abbildungen `p1` und `p2` in einem Plot visualisiert.
