...
-   Der Blogpost [Marginal and conditional effects for GLMMs with `{marginaleffects}`](https://www.andrewheiss.com/blog/2022/11/29/conditional-marginal-marginaleffects/) liefert nochmal Einblicke in die Möglichkeiten auch die *Marginal effect models* auf lineare gemischte Modelle anzuwenden.
...
Wir können auch alle Vergleiche zu dem ersten Koeffizienten rechnen. Bitte beachte, dass wir unser Modell ohne den Intercept gebaut haben und somit hier nur die reinen Mittelwerte der Gruppen vorliegen haben.
...
::: callout-tip
## Es geht so viel mehr... auf allen Ebenen.
...
Dann einmal den klassischen Tests, ob sich die beiden Entwicklungstände signifikant unterscheiden. Wir erhalten hier einen p-Wert größer als das Signifikanzniveau $\alpha$ und daher können wir die Nullhypothese nicht ablehnen.
...
Du findest dann im [Kapitel zur Äquivalenz oder Nichtunterlegenheit](#sec-noninf) noch mehr Informationen zu den Hintergründen. Da ich den Äquivalenztest faktisch nicht anwende, belasse ich den Abschnitt hier kurz. Wir können den Äquivalenztest einfach in `{marginaleffects}` nutzen und das ist auch erstmal gut zu wissen.
