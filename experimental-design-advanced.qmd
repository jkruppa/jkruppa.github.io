...
Die Struktur der Daten ist wie folgt gegeben. Jedes Level der Düngerstufe `fert` ist in dem Faktor des Bodens `soil` enthalten. Die beiden Behandlungen sind dann wiederum jeweils vollständig in den Blöcken `block` vorhanden. In der @fig-mermaid-01 sehen wir einmal den Zusammenhang zwischend den drei Faktoren
...
%%| fig-cap: "text"
flowchart LR
    A(fert):::factor --- B(((nested))) --> E(block):::factor
    C(soil):::factor --- D(((nested))) --> E
...
```{mermaid}
%%| label: fig-mermaid-02
%%| fig-width: 6
%%| fig-cap: "text"
flowchart LR
    A(fert):::factor --- B(((nested))) --> C(soil):::factor --- D(((nested))) --> E(block):::factor
    classDef factor fill:#56B4E9,stroke:#333,stroke-width:0.75px
```
