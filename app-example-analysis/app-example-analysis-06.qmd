...
Abschließend können wir dann die Barplots mit den Fehlerbalken und dem *Compact letter display* darstellen. Ich habe hier mal eine rote Farbe für die Buchstaben gewählt, aber du kannst da gerne eine andere Farbe nutzen. so sieht man aber die Buchstaben auf den ersten Blick.
...
Im folgenden schaue ich mir nur die Blütenanzahl `flowers` als Outcome an. Die anderen Outcomes sind dann einfach nur Copy&Paste von dieser Analyse der Blütenanzahl.
