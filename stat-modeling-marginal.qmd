...
Bei unseren Daten zu der Enzymeaktivität können wir hier einmal ein *Generalized additive model* (abk. *GAM*) anpassen. Wir müssen nur einmal über das `s()` angeben, welche Einflussvariablen nicht linear sein solen.
...
#| message: false
#| warning: false
predictions(cov2_fac1_fit, by = "stage")
```
