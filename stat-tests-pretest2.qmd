...
#| echo: false
#| warning: false
#| label: fig-ggplot-anova-boxplot-2fac-1
#| fig-align: center
#| fig-height: 4
#| fig-width: 8
...
#| echo: false
#| warning: false
#| label: fig-ggplot-anova-boxplot-2fac-2
#| fig-align: center
#| fig-height: 4
#| fig-width: 8
...
Wir bauen wir usn jetzt die Barplots oder Säulendiagramme? Entweder direkt aus `{emmeans}`, wie ich dir das weiter unten zum *Compact letter display* zeige oder eben als Wiederholung des [Kapitels zur Visualisierung von Daten](#sec-eda-ggplot). Wir bauen uns also einmal den einfaktoriellen Barplot wie auch den zweifaktoriellen Barplot.
...
p3 <- ggplot(data.frame(x = c(-3.25, 3.25)), aes(x)) +
  theme_minimal() +
  geom_hline(yintercept = 0, gray = "gray50") +
