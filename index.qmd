...
*Kruppa-Scheetz, Jochen (`r year(today)`) Openbook Bio Data Science - Der entgültige Leidfaden, https://jkruppa.github.io/ (Zugriff am `r day(today)`. `r month(today, label = TRUE)`. `r year(today)`)*
:::
