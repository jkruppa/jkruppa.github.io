...
Die asymptotische Effizienz des Kruskal-Wallis-Tests liegt bei $0.955$, die des Friedman-Tests bei $0.955 \cdot J/(J+1)$, also z.B. 0.64 (für $J=2$) und 0.87 (für $J=10$), wobei $J$ die Anzahl der Gruppen oder Versuchsbedingungen also Spalten ist.
