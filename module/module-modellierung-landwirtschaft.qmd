...
-   Einführung in die statistischen Modellierung sowie deren Interpretation und Bewertung anhand der multiplen linearen Regression.
-   Besonderheiten der statistischen Modellierung von Zeitreihen und räumlichen Daten ("spatial data") sowie deren abhängiger Varianzstrukturen.
...
-   Die Studierenden sind in der Lage Modelleierungen mit den notwendigen Funktionen und Paketen in R durchzuführen.
