...
Neben der Möglichkeit unser Modell direkt zu testen und dann weiter in `aov()` oder `emmeans()` zu verwenden, können wir auch separat unsere Gruppen auf Varianzhomogenität testen.
