## Bioinformatik {#sec-module-bioinformatik}

### Inhalte und Qualifikationsziele des Moduls

#### Kurzbeschreibung

Die Bioinformatik findet in vielen wissenschaftlichen Bereichen der Omics-Forschung ihre Anwendung. Neben der klassischen Anwendung zum Auffinden von genetischen Markern für Krankheiten oder genetischen Dispositionen in der Humangenetik, findet die Bioinformatik zur Entschlüsslung der genetischen Vererbung in der Züchtung von Tieren und Pflanzen ihren Platz. Die Auswertung von genetischen Daten ist weitreichend. In dem Modul wird dem genetischen Paradigma vom Gen zum Protein gefolgt. Neben der Analyse von genetischen Markern auf der DNA-Ebene wird die Expression von Genen über die mRNA sowie die schlussendlich wirksamen Proteinexpression betrachtet. Auch mögliche regulative Elemente der DNA Expression wie die Metyhlierung wird in die Betrachtung mit aufgenommen. In dem Modul "Bioinformatik" lernen Studierende die Grundlagen für das spätere wissenschaftliche und angewandte Arbeiten im Bereich der Omics-Forschung. Das Modul vermittelt die dafür notwendigen statistischen Grundkenntnisse. Der Fokus liegt hier auf der Darstellung, Erfahrung und statistischen Auswertungen von hochdimensionellen, genetischen Daten.

Quantitative Genetik

GWAS

High-through-put genotyping - Next-generation-sequencing - Whole-genome-sequencing vs RNA-seq 3. Quantitative genetics

Parallel dazu werden in dem Modul die erworbenen theoretischen Kenntnisse durch die Auswertung in R/Bioconductor für die Studierenden umsetzbar und erfahrbar gemacht. In dem Modul "Bioinformatik" werden somit die Grundkenntnisse für die praktische Auswertung von Omics-Daten erworben.
