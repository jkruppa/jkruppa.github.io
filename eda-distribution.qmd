...
![Darstellung von dem Zusammenhang von `pnorm(q = 1.96)` und `qnorm(p = 0.025)`. Mit der Option `lower.tail` bestimmen wir auf welche Seite der Verteilung wir sein wollen.](images/distribution-t.png){#fig-dist-t-01 fig-align="center" width="100%"}
