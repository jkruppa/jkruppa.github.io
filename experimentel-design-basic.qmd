...
![Visualisierung des *complete randomized design* mit einer Behandlung und vier Behandlungsleveln.](images/experimental-design-table-crd.png){#fig-design-table-crd fig-align="center" width="60%"}
...
![Visualisierung des *complete randomized design* mit einer Behandlung und vier Behandlungsleveln.](images/experimental-design-table-block.png){#fig-design-table-block fig-align="center" width="65%"}

![Visualisierung des *complete randomized design* mit einer Behandlung und vier Behandlungsleveln.](images/experimental-design-table-block-rep.png){#fig-design-table-block-rep fig-align="center" width="100%"}

test
:::

See @fig-table-rcbd for examples. In particular, @fig-design-table-block and @fig-design-table-block-rep
...
::: column-page
![Visualisierung des *complete randomized design* mit einer Behandlung und vier Behandlungsleveln.](images/experimental-design-rcbd.png){#fig-design-rcbd fig-align="center" width="80%"}
:::

### Daten

$\beta_{0} = \beta_{A} = 20$ $\beta_{B} = 15$ $\beta_{C} = 10$ $\beta_{D} = 5$

$\beta_{0} = \beta_{I} = 0$ $\beta_{II} = 0$ $\beta_{III} = 0$
...
```{r}
rcbd_tbl <- factor_tbl %>% 
  mutate(rsp = as.numeric(model_mat %*% c(20, 15, 10, 5, 0, 0)) + rnorm(n(), 0, 2))
...
rcbd_tbl %>% 
  ...
  set_names(c("Factor trt", "Mean of level", "Difference to level A")) %>% 
  kable(align = "c", "pipe")
```
...
::: column-page
![Visualisierung des *complete randomized design* mit einer Behandlung und vier Behandlungsleveln.](images/experimental-design-lsd.png){#fig-design-lsd fig-align="center" width="80%"}
:::

## Alpha design {#sec-alpha}

::: column-page
![Visualisierung des *complete randomized design* mit einer Behandlung und vier Behandlungsleveln.](images/experimental-design-alpha.png){#fig-design-alpha fig-align="center" width="80%"}
:::
...
::: column-page
![Visualisierung des *complete randomized design* mit einer Behandlung und vier Behandlungsleveln.](images/experimental-design-split.png){#fig-design-split fig-align="center" width="80%"}
:::
