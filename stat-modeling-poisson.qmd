...
["Exposure" and offset](https://en.wikipedia.org/wiki/Poisson_regression#.22Exposure.22_and_offset)

[When to use an offset in a Poisson regression?](https://stats.stackexchange.com/questions/11182/when-to-use-an-offset-in-a-poisson-regression)

[Models with offsets](https://cran.r-project.org/web/packages/emmeans/vignettes/sophisticated.html#offsets)

```{r}


ins <- tibble(n = c(500, 1200, 100, 400, 500, 300),
...
insects_tbl %>% 
  ...
  summarise(mean = round(mean(thripse), 2)) 
```
