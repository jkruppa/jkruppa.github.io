...
![Ein `select()` mit Werten](images/programing/schrank/schrank_select.png){#fig-dplyr-select fig-align="center" width="100%"}
...
![Ein `mutate()` mit Werten](images/programing/schrank/schrank_mutate.png){#fig-dplyr-mutate fig-align="center" width="100%"}
