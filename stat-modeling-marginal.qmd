...
#| message: false
#| warning: false
avg_predictions(enzyme_1fac_fit, by = c("grp"), vcov = "HAC")
```
...
#| warning: false
avg_predictions(enzyme_1fac_fit, by = c("grp"), vcov = "HAC") |> 
  hypotheses(~pairwise, multcomp = "bonferroni")
```
...
avg_predictions(enzyme_2fac_fit, by = c("grp", "type"), vcov = "HAC",
                hypothesis = ~pairwise | type, multcomp = "bonferroni") 
```
