...
## Fahrräder in Osnabrück {.unnumbered}
...
ggplot(bikes_tbl, aes(tag_im_Jahr, anzahl_cum,
  ...
  geom_line(data = tibble(tag_im_Jahr = c(275, 365), anzahl_cum = c(996765, 1388241),
                           jahr = as_factor(c(2025, 2025))),
            linetype = 11) +
  geom_line(data = tibble(tag_im_Jahr = c(280, 365), anzahl_cum = c(1010267, 1381791),
                           jahr = as_factor(c(2025, 2025))),
            linetype = 12) +
  geom_line(data = tibble(tag_im_Jahr = c(289, 365), anzahl_cum = c(1045347, 1372153),
                           jahr = as_factor(c(2025, 2025))),
            linetype = 12) +
  theme(panel.grid.minor = element_blank(),
        legend.position = "top")
