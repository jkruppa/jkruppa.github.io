...
Es stehen dir Folgende logische Operatoren zu Verfügung wie in @tbl-logical-operators gezeigt. Am Anfang ist es immer etwas schwer sich in den logischen Operatoren zurechtzufinden. Daher kann ich dir nur den Tipp geben einmal die Operatoren selber auszuprobieren und zu schauen, was du da so rausfilterst.
...
: Logische Opertairen und R und deren Beschreibung {#tbl-logical-operators}
...
Auf den ersten Blick ändert sich nicht viel. Es entsteht aber die Zeile `# Groups: animal [3]`. Wir wissen nun, dass wir nach der Variable `animal` mit drei Gruppen die Datentabelle gruppiert haben. Die Anwendung siehst du in @sec-desc-group-by bei der Berechung von deskriptiven Maßzahlen.
...
```{r}
data_tbl <- tibble(animal = c("cat", "cat", "cat", "dog", "dog"),
                   site = c("village", "village", "town", "town", "town"),
                   time = c("t1_1", "t2_2", "t3_3", "t3_4", "t3_5"))
```
...
## Mit `purrr` wiederholt Dinge tun {#sec-purrr}
