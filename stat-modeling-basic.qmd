...
Im letzten Schritt wollen wir uns einmal das volle Modell anschauen. Wir nehmen in das Modell `lm()` alle Variablen mit hinein. Die Funktion `model.matrix()` gibt uns die Modelmatrix wieder.
