...
foo <- rq(length ~ versuchsgruppe + time_fct + versuchsgruppe:time_fct, tau = 0.5, method = "pfnb",
   gurke_time_len_tbl)



emmeans(foo, pairwise ~ versuchsgruppe | time_num, 
        at = list(time_num = c(1, 7, 14))) 

mr <- rq(wage ~ education, data = Wage, tau = 0.5)

emmeans::emmeans(foo, pairwise ~ versuchsgruppe | time_num, weights = "prop", adjust = "bonferroni")
