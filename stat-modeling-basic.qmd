...
-   Wir fragen uns, was ist eigentlich ein Variance Inflation Factor (VIF) für kontinuierliche $x$ in @sec-vif.
...
[Neben dem $AIC$ gibt es auch das Bayesian information criterion ($BIC$). Auch beim $BIC$ gilt, je kleiner das BIC ist, desto besser ist das BIC.]{.aside}
