...
Die Blaualgen hat die [Bändererze](https://de.wikipedia.org/wiki/B%C3%A4ndererz) erschaffen und somit einen Marker in der Geologie hinterlassen. Jahrtausende später hat der Meteoriteneinschlag die [K-P-Grenze](https://de.wikipedia.org/wiki/Kreide-Pal%C3%A4ogen-Grenze) erschaffen und den Beginn des Aussterben der Dinosaurier markiert. Nun ist die Frage, gibt es eine solche Grenze auch für die Menschheit im Gestein? Viele Jahre wurde diskutiert welche Grenze wir nehmen.

In dem Crawfordsee in Ontario, Kanada werden im warmen Sommer werden Kalzitminerale ausgefällt, die herabrieseln und alljährlich eine markante weiße Lage bilden. Diese Lage kannst du dir wie Baumringe vorstellen. Nun gibt es aber eine ganz besondere Linie in dem See. Diese Linie markiert die frühen 1950er-Jahren mit dem Isotop Plutonium-239 als nachweisbare globale Signatur von Kernwaffentests. Nun ist die Frage ob der See als "Global Boundary Stratotype Section and Point" dienen kann um die Zeitenwende zu markieren.
