...
#| fig-height: 3.5
#| fig-width: 7
#| fig-cap: "Scatterplot der kontinuierlichen x-Werte und kontinuierlichen y-Werte. In einem Modell wollen wir die Abhängigkeit von y und x modellieren. Ein  *Marginal effect models* aggregiert die Ergebnisse des Modelles für die Änderung in den x-Werten. **(A)** Linearer Zusammenhang. **(B)** Quadratischer Zusammenhang. *[Zum Vergrößern anklicken]*"
#| label: fig-marginal-model-intro-00

p1 <- ggplot(modell_line_tbl, aes(x, y)) +
  theme_marginal() +
  geom_point2() +
  theme(axis.text = element_blank()) +
  geom_function(fun = \(x) 1.5 + 0.75 * x, color = "#E69F00", linewidth = 1) 

p2 <- ggplot(modell_square_tbl, aes(x, y)) +
  theme_marginal() +
  geom_point2() +
  theme(axis.text = element_blank()) +
