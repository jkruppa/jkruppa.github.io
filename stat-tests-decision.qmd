...
In den folgenden Kapitel werden wir verschiedene statistische Tests kennenlernen.
...
: Zusammenfassung der Testentscheidung nach Neyman-Pearson unter der Nutzung der Teststatistik, dem p-Wert und dem 95% Konfidenzintervall. Die Entscheidung nach der Teststatistik ist veraltet und dient nur dem konzeptionellen Verstehen. Angewandt wird der p-Wert und das 95% Konfidenzintervall. {#tbl-comp-t-p-ki}
:::
...
Wir wollen uns dem freuquentistischen Hypothesentesten über die Idee der Teststatistik annähern.
...
-   $\bar{y}_1$ dem Mittelwert für die Gruppe 1.
-   $\bar{y}_2$ dem Mittelwert für die Gruppe 2.
-   $s_{p}$ der gepoolten Standardabweichung über beide Gruppen 1 und 2.
-   $n_g$ der Gruppengröße der Gruppe 1 und 2. Wir nehmen an beide Gruppen sind gleich groß.
