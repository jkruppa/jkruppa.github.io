...
Statistische Lehr-Lerninhalte

-   Einführung in die explorative Datenanalyse mit Fokus auf dem Boxplot und dem Barplot und deren statistischen Maßzahlen.
-   Einführung in das statistische Testen sowie der Testtheorie mit dem Prüfen von statistischen Hypothesen beinhaltend p-Wert und das 95% Konfidenzintervalle.
-   Berechnung des Student-, Welch- und gepaarten t-Test. Berechnung der einfaktoriellen ANOVA. Einführung in das multiple Testen von mehreren Mittelwerten und die Darstellung im compact letter display.

Programmier Lehr-Lerninhalte
...
Die Studierenden können dies und das tun

Die Studierenden sind in der Lage dies und das zu tun
...
-   können die Anforderungen an einen Datensatz zur Verwendung in R bennnen
-   können in R Objekte, Funktionen und Zahlenvektoren unterscheiden und kennen die gängigen Operatoren
-   können den Ablauf für die Erstellung einer explorativen Datenanalyse in R beschreiben
