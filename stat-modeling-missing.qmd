...
Die Spalte `imp_run` gibt uns dann die Imputation $m$ wieder. Die $0$-te Imputation sind dabei die Orginaldaten. Wie du schon sehen kannst, wird das alles sehr schnell sehr groß und wir müssen hier mit fortgeschrittner Programmierung ran, wenn die Funktion `pool()` nicht will.
