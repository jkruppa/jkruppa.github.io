...
Die *zweifaktorielle* ANOVA vergleicht die Parameter mehrerer Normalverteilungen von zwei Faktoren miteinander. Oder etwas anders formuliert, vergleicht die ANOVA die Mittlelwerte von mehreren Gruppen bzw. Behandlungen miteinander. Dabei kann die *zweifaktorielle* ANOVA auch die Interaktion zwischen zwei Variablen abbilden.
:::
...
Wir können das einmal numerisch mit einem kritischen Wert für $F_{\alpha = 5\%} = 3.55$ durchspielen. Nehmen wir folgende Summe für $MS_{treatment}$ aus den einzelnen $MS$ einmal an. Wir sehen dabei das die Gruppe F einen $MS_D = 7$ hat. Dieser Wert ist vermutlich zu klein.
