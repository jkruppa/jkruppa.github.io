...
R Packet `HDclassif` den Datensatz `wine` auch bekannt vom [UC Irvine Machine Learning Repository - Wine Dataset](https://archive.ics.uci.edu/dataset/109/wine). Wie immer von mir leicht modifiziert.
