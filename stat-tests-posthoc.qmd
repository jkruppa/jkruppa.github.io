...
!["Total soluble solids (TSS) in 'Alicia' papaya propagated by seed, grafting, and in vitro (n = 12 ± s.e.), evaluated from April 2020 to May 2021 at the maturation of 100% yellow skin color. The line marks the 10 °Brix value, commonly referred to as the minimum for papaya commercialization. Different letters on the same date indicate statistically significant differences between propagation procedures (Tukey's test p \< 0.05)." Quelle: @salinas2023plant](images/eda/zerforschen_papaya.png){#fig-zerforschen-papaya fig-align="center" width="60%"}

!["Panicles with commercial fruit (%) at 2019 and 2020 harvest. In the same year, different letters indicate significant differences among treatments (Tukey's test p\<0.05)." Quelle: @sanchez2022hoverfly](images/eda/zerforschen_hoverfly.png){#fig-zerforschen-papaya fig-align="center" width="60%"}
...
## Gruppenvergleich unter Varianzheterogenität {#sec-posthoc-var-heterogen}
