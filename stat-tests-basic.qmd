...
Im Folgenden möchte ich dir dann noch ein paar Beispiele der Verwendung des p-Wertes in der Praxis geben. Ich habe die Abbildungen zum Teil in der Hochschule Osnabrück gemacht. Hier siehst du dann einmal wie vielfältig dann der p-Wert auch dargestellt wird. Wir können den p-Wert als Zahl darstellen oder aber auch als Sterne `*` mit der entsprechenden Erklärung in der Überschrift.
