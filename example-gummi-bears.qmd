...
Aktuell hat der Datensatz $N = `r nrow(gummi_tbl)`$ Beobachtungen also auch Personen, die mitgemacht haben. Da der Datensatz aber immer weiter wächst brauchen wir wirklich R dazu um den Datensatz uns anschauen zu können.
