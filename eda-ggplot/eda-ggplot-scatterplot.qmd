...
Neben der klassischen Form eine Grade durch die Punkte zu zeichnen haben wir auch die Möglichkeit das [R Paket `{ggpmisc}`](https://cran.r-project.org/web/packages/ggpmisc/vignettes/user-guide.html) zu nutzen. Hier nehmen wir wieder unsere Daten und wollen dann wissen, ob sich die Sprungweite über das Gewicht der Flöhe unterscheidet.
