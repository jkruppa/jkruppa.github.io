...
#| fig-height: 5
#| fig-width: 10
#| fig-cap: "Beispiel für eine uniforme Verteilung anhand der Anzahl der Gummibärchen pro Tüte nach Farbe. **(A)** Verteilung der beobachteten Anzahl der Gummibärchen pro Tüte nach Farbe. **(B)** Verteilung der theoretischen Anzahl der Gummibärchen pro Tüte nach Farbe. *[Zum Vergrößern anklicken]*"
...
p2 <- p +
  ...
  labs(x = "", y = "Anzahl") +
  geom_label(stat='count', aes(label=(..count..)/sum(..count..)), size = 3) +
  theme(axis.text.y = element_blank())
