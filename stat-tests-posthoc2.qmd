...
-   $f_1$ gleich dem zweiten Faktor, wie der Messort als `site`.
-   $f_1:f_2$ gleich dem Interaktionsterm zwischen den beiden Faktoren Tierart und Messort.
-   $z_1$ als weiterer experimenteller Faktor der Umwelt, Zeit oder anderer Einwirkung auf den Messwert.
...
Dann schaue dir den Abschnitt zu [Multiple Gruppenvergleiche für Wahrscheinlichkeiten](#sec-mult-comp-beta-reg) an -- dein Outcome ist eine Wahrscheinlichkeit für das Eintreten eines Ereignisses oder aber die Rate eines Erfolges an Misserfolgen.
