...
Wenn du den folgenden Kasten einmal über den Pfeil `>` aufklappst, denn siehst du den Inhalt der `app.R` für unsere Shiny App `Hello_Shiny`. Einfach über die Zahlen am rchten Rand fahren um meine Kommenatre zu sehen. Du musst immer das Paket `shiny` laden und natürlich die anderen R Pakete die du dann verwenden willst. Faktisch ist ja eine Shiny App nichts anderes als ein R Skript.
...
flowchart LR
    subgraph ide1 ["/home/myWork/Hello_Shiny"]
    direction LR
