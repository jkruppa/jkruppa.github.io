...
Beginnen wir mit den drei Effektschätzern der ANOVA. Ich empfehle ja bei einer einfaktoriellen ANOVA immer das $\eta^2$ als Effektmaß. Wir haben ja mit dem $\eta^2$ einen Wert für den Anteil der Varianz des Messwertes der durch den Behanldungsfaktor erklärt wird. Je mehr Vairanz durch die Behandlung erklärt wird, desto besser in unserem geplanten Experiment.
