...
|----|----|----|
| **(1.)** | Wähle ein Modell aus der [Liste der Modelle mit der entsprechenden Funktion](https://parsnip.tidymodels.org/articles/Examples.html). | Bsp. `linear_reg()` |
