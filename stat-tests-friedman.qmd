...
Eigentlich sind die Datensätze hier zweimla das Gleiche, aber es gibt eben diese [zwei Arten des Friedman Tests](https://math.montana.edu/jobo/thainp/ksampa.pdf), die im Orbit rumgeistern. Deshalb hier im Folgenden einmal der agrawissenschaftliche Datenstz mit einem, Block in den Zeilen sowie einen Datensatz zu Messwiederholungen an Individuen mit unseren Flöhen. Damit haben wir beide Fälle abgefrühstückt und können uns dann die Auswertung einmal näher anschauen.

#### Randomisiertes vollständiges Blockdesign {.unnumbered .unlisted}

Randomisiertes vollständiges Blockdesign (eng. *Randomized Complete Block Design*)
...
#### Design mit wiederholten Messungen {.unnumbered .unlisted}

Einfaches Design mit wiederholten Messungen (eng. *Simple Repeated Measures Design*)
