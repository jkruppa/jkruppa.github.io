...
lab_tbl <- rbind(rmvnorm(n = 8, mean = c(20, 20, 5, 120, 50), sigma = sigma),
      rmvnorm(n = 8, mean = c(20, 20, 5, 120, 50), sigma = sigma),
      rmvnorm(n = 8, mean = c(50, 20, 5, 160, 20), sigma = sigma),
      rmvnorm(n = 8, mean = c(50, 20, 5, 160, 20), sigma = sigma),
      rmvnorm(n = 8, mean = c(20, 20, 15, 80, 15), sigma = sigma),
      rmvnorm(n = 8, mean = c(20, 20, 15, 80, 15), sigma = sigma)) |> 
  as_tibble() |> 
