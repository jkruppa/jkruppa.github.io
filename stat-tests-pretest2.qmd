...
Neben den klasischen Abbildungen und deren Interpretation gibt es natürlich auch noch R Pakete, die dir bei der Bewertung helfen. Das [R Paket `{olsrr}`](https://olsrr.rsquaredacademy.com/articles/intro.html) erlaubt eine weitreichende Diagnostik auf einem normalverteilten Outcome $y$. Es ist besser sich die Diagnostikplots anzuschauen, als die statistischen Pre-Tests zu rechnen. Besonders bei kleiner Fallzahl. Ich persönlich bevorzuge das R Paket `{performance}`, da wir hier dann einfach bessere Abbildungen vorliegen ahben. Darüber hinaus funktioniert das R Paket `{performance}` auf mehr Modellen und ist auch einfacher zu bedienen. Wie immer hat natürlich jedes Paket seine Funktionen und ich stelle hier mal alles vor. Es ist ja ein Kochbuch, also suche dir dann raus was du brauchst für deine Analysen.
