...
Dann müssen wir natürlich auch noch die Ergebnisse der einfaktoriellen ANOVA berichten. Dafür gibt es aber das [R Paket `{report}`](https://easystats.github.io/report/) welches dir dann bei der Interpretation der Ausgabe deiner ANOVA hilft. Nicht alle Varianten funktionieren mit dem Paket `{report}`, dehalb hier nur ein Beispiel.
