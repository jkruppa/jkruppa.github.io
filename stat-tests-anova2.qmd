...
#| fig-height: 10
#| fig-width: 10
#| fig-cap: "Visualisierung möglicher Kombinationen von Effekten der Faktoren A mit den Leveln $A.1$, $A.2$ und $A.3$ sowie dem Faktor B  mit den Leveln $B.1$ und $B.2$ anhand von Boxplots. Eine Interaktion wird nicht dargestellt. Die p-Werte sind abgeschätzt. **(A)**  **(B)**   **(C)**   **(D)**  *[Zum Vergrößern anklicken]*"
