...
[R Paket `{vcd}`](https://www.datavis.ca/courses/VCD/vcd-tutorial.pdf)
...
[R Paket `{irr}`](https://cran.r-project.org/web/packages/irr/irr.pdf) ist schon ziemlich alt und hat auch sehr schlechte bis gar keine Hilfeseiten. Wenn man weiß, was man barucht und die Funktion bedeuten, dann kannst du das Paket gut nutzen.
