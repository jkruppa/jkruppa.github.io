...
In der @fig-interact-anova-1 sehen wir den Interaktionsplot. Auf der y-Achse ist die Sprunglänge abgebildet und auf der x-Achse der Faktor `animal`. Die einzelnen Farben stellen die Level des Faktor `site` dar.
