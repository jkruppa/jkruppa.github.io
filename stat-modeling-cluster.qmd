...
fviz_nbclust(na.omit(animals_df), kmeans, method = "wss")
fviz_nbclust(na.omit(norm_creature_df), kmeans, method = "gap_stat")
```
...
hc_fit <- hc_spec %>%
  fit(~ warm_blooded + fly + vertebrate + threatened + live_in_groups + hair,
      data = animals_tbl)
