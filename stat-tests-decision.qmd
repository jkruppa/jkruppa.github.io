...
Ein frequentistischer Hypothesentest beantwortet die Frage, mit welcher Wahrscheinlichkeit $Pr()$ die Daten $D$ aus dem Experiment zu beobachten wären, wenn es keinen Effekt gäbe ($H_0$).
...
data_tbl <- tibble(animal = gl(2, 4, labels = c("cat", "dog")),
                   jump_length = c(8.5, 9.9, 8.9, 9.4, 8.0, 7.6, 9.1, 7.5)) 
