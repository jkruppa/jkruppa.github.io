...
Es geht um Steigungen (eng. *slopes*) und Vorhersagen (eng. *predictions*)

Was sind Steigungen?

:   Die Traktion der Geraden über die Werte auf der x-Achse hinweg.

Was ist die Vorhersage?

:   Die y-Werte auf der Geraden für jeden beliebigen Wert auf der x-Achse.
...
#| fig-height: 3.5
#| fig-width: 7
#| fig-cap: "Visualisierung einer simplen linearen Regression mit einem kontinuierlichen Messwert (y) und einer kontinuierlichen Einflussvariable (x) dargestellt. Eine geschätzte Gerade durch die Punktewolke gelegt. Wie lautet die Geradengleichung und liegen die Punkte auf der Geraden?"
