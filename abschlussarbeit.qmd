...
bsc_tbl |> 
  ...
  geom_vline(xintercept = min(bsc_tbl$Seiten, na.rm = TRUE), linetype = 2) +
  geom_hline(yintercept = min(bsc_tbl$Referenzen, na.rm = TRUE), linetype = 2) +
  scale_fill_gradient2(name = "FC", low = 'blue', mid = "gray", high = 'red', midpoint = 0) +
  scale_x_continuous(breaks = c(0, min(bsc_tbl$Seiten, na.rm = TRUE), 40, 80, 120),
                     limits = c(0, 125)) +
  scale_y_continuous(breaks = c(0, min(bsc_tbl$Referenzen, na.rm = TRUE), 40, 80, 120),
                     limits = c(0, 125)) 
